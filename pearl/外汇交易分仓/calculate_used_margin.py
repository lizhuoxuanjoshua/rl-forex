def calculate_used_margin(traded_lots, leverage_ratio, friction_cost_percentage, current_price):
    ...
    total_margin_used = margin_required + friction_cost
...
if __name__ == "__main__":
    ...
    used_margin = calculate_used_margin(traded_lots, leverage_ratio, friction_cost_percentage, current_price)
