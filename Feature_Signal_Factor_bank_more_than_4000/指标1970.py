...
#开始
    ...
    丁短线回踩支撑=EMA(C,10)
    丁丁启动线=(EMA(C,20))
    a=(CROSS(丁丁主力线,丁丁跟随主力线) ) * ( C>O ) * ( C>REF(C,1) ) * (( C/REF(C,1)>=1.018) ) + ( (CROSS(丁丁跟随主力线,丁丁辅助主力线) )) * ( C>O ) * ( C>REF(C,1) ) * ( C/REF(C,1)>=1.018 ) + ( (CROSS(丁丁跟随主力线,丁短线回踩支撑) )) * ( C>O ) * ( C>REF(C,1) ) * ( C/REF(C,1)>=1.018 ) + ( (CROSS(丁丁主力线,丁丁辅助主力线) )) * ( C>O ) * ( C>REF(C,1) ) * ( C/REF(C,1)>=1.018 ) + ( (CROSS(丁丁主力线,丁短线回踩支撑) )) * ( C>O ) * ( C>REF(C,1) ) * ( C/REF(C,1)>=1.018 ) + ( (CROSS(丁丁跟随主力线,丁丁辅助主力线) )) * ( C>O ) * ( C>REF(C,1) ) * ( C/REF(C,1)>=1.018 ) + ( (CROSS(丁丁跟随主力线,丁丁启动线) )) * ( C>O ) * ( C>REF(C,1) ) * ( C/REF(C,1)>=1.018 ) + ( (CROSS(丁丁辅助主力线,丁短线回踩支撑) )) * ( C>O ) * ( C>REF(C,1) ) * ( C/REF(C,1)>=1.018 ) + ( (CROSS(丁丁跟随主力线,丁丁启动线) )) * ( C>O ) * ( C>REF(C,1) ) * ( C/REF(C,1)>=1.018 ) * ( CROSS(丁丁主力线,丁丁启动线))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
