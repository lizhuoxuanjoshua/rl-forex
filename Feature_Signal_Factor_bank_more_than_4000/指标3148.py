...
#开始
    ...
    X_2=(EMA(X_1,9))
    X_3=(2*(X_1-X_2))
    X_4=(1.25*X_1-0.25*X_2)
    X_5=((X_4*13*27-27*11*EMA(CLOSE,12)+13*25*EMA(CLOSE,26))/28)
    X_6=((X_1*13*27-27*11*EMA(CLOSE,12)+13*25*EMA(CLOSE,26))/28)
    X_7=((X_2*13*27-27*11*EMA(CLOSE,12)+13*25*EMA(CLOSE,26))/28)
    X_8=((X_5+X_7)/2)
    X_9=(np.arctan((X_6-REF(X_6,1))/REF(X_6,1)*100)*180/3.14159)
    X_10=(X_5)
    X_11=(X_6)
    X_12=(X_8)
    X_13=(X_7)
