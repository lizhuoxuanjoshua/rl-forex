...
#开始
    ...
    T1=( barslast(EMA(CLOSE,5)<REF(EMA(CLOSE,5),1))==1)
    C1=(np.maximum(C,O))
    高1=(np.maximum(REF(C1,1),REF(C1,2)))
    高2=(np.maximum(高1,REF(C1,3)))
    高3=(np.maximum(高2,REF(C1,4)))
    高4=(np.maximum(高3,REF(C1,5)))
    高5=(np.maximum(高4,REF(C1,6)))
    高6=(np.maximum(高5,REF(C1,7)))
    高7=(np.maximum(高6,REF(C1,8)))
    高8=(np.maximum(高7,REF(C1,9)))
    高9=(np.maximum(高8,REF(C1,10)))
    高10=(np.maximum(高9,REF(C1,11)))
    高11=(np.maximum(高10,REF(C1,12)))
    高12=(np.maximum(高11,REF(C1,13)))
    最高=(np.maximum(高12,REF(C1,14)))
    T2=(C>最高)
    a=(T1 ) * ( T2)
#结束
    买入 = a
