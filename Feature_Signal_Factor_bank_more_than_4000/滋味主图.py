...
#开始
    ...
    MA13=(MA(CLOSE,13))
    IA1=((MA(CLOSE,5)+MA(CLOSE,10)+MA(CLOSE,25))/3)
    IA2=((MA(CLOSE,5)+MA(CLOSE,10)+MA(CLOSE,20)+MA(CLOSE,30)+MA(CLOSE,60)+MA(CLOSE,120))/6)
    IA3=((MA(CLOSE,20)+MA(CLOSE,60)+MA(CLOSE,120))/3)
    IA4=((MA(CLOSE,13)+MA(CLOSE,34)+MA(CLOSE,55))/3)
    a=(CROSS(IA1,IA4))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
