...
#开始
    ...
    VARD=(REF(CLOSE,1))
    VARE=(((sma(np.maximum((CLOSE - VARD),0),5,1) / sma(np.abs((CLOSE - VARD)),5,1)) * 100))
    VAR11=((((((MA(AMOUNT,5) / MA(VOL,5)) ) - ((MA(AMOUNT,110) / MA(VOL,110)) )) / ((MA(AMOUNT,5) / MA(VOL,5)))) < (0 - 0.273)))
    VAR12=((((CLOSE - MA(CLOSE,30)) / MA(CLOSE,30)) < (0 - 0.125)))
    VAR13=((VAR11 ) * ( VAR12))
    VAR14=(((((VAR2 >= (0 - 45)) ) * ( (VAR2 <= (0 - 10))) ) * ( (VAR3 <= (0 - 15))) ) * ( (VAR4 <= (0 - 20))))
    VAR15=((count(VAR14,1) >= 1))
    VAR16=((VAR13 ) * ( VAR15))
    VAR17=(1)
    VAR1C=(EMA(CLOSE,34))
    VAR1E=(MA((VAR1C * 0.82),5))
    VAR20=(((((((MA(AMOUNT,5) * VAR17) / MA(VOL,5)) ) - ((MA(AMOUNT,125) / MA(VOL,125)))) / ((MA(AMOUNT,5) / MA(VOL,5)))) < ((0 - 0.4) * VAR17)))
    VAR21=(hhv(HIGH,500))
    VAR22=(llv(LOW,500))
    VAR23=(hhv(HIGH,250))
    VAR24=(llv(LOW,250))
    ...
    VAR45=(((((((((((((((CLOSE < VAR1E) ) * ( VAR20) ) * ( (CLOSE < VAR43))) ) + ( ((((CLOSE < VAR1E) ) * ( VAR31) ) * ( VAR20))) ) + ( (((CLOSE < VAR1E) ) * ( (CLOSE < VAR43)))) ) + ( ((((CLOSE < VAR1E) ) * ( VAR20) ) * ( (CLOSE < VAR43)))) ) + ( ((VAR20 ) * ( (CLOSE < VAR2C)))) ) + ( (((VAR20 ) * ( VAR31) ) * ( (VAR44 < (0 - 1.5))))) ) + ( ((VAR20 ) * ( (CLOSE < VAR1E)))) ) + ( ((VAR20 ) * ( (VAR44 < (0 - 1.5))))) ) + ( ((VAR31 ) * ( (CLOSE < VAR43)))) ) + ( (((CLOSE < VAR2C) ) * ( (VAR44 < (0 - 1.5))))) ) + ( (((CLOSE < VAR1E) ) * ( VAR31))))
    VAR4B=((((HIGH + LOW) + CLOSE) / 3))
    VAR4C=(((VAR4B - MA(VAR4B,14)) / (0.015 * AVEDEV(VAR4B,14))))
    VAR4F=((VAR11 ) * ( VAR12))
    VAR50=(((((VAR2 >= (0 - 45)) ) * ( (VAR2 <= (0 - 7))) ) * ( (VAR3 <= (0 - 11))) ) * ( (VAR4 <= (0 - 14))))
    VAR51=((count(VAR50,1) >= 1))
    VAR52=((VAR4F ) * ( VAR51))
    VAR53=((((((VAR20 ) * ( (CLOSE < VAR1E)) ) * ( VAR31) ) * ( (CLOSE < VAR2C)) ) * ( VAR45) ) * ( VAR52))
    VAR5B=(((((((VAR2 >= (0 - 15.8)) ) * ( (VAR2 <= (0 - 12.2))) ) * ( (VAR3 <= (0 - 20.8))) ) * ( (VAR4 <= (0 - 27.5))) ) * ( (VARE <= 11.7)) ) * ( (VAR4C <= (0 - 145))))
    VAR62=((REF(CLOSE,2) * 0.865))
    VAR63=((REF(CLOSE,13) * 0.772))
    VAR64=(np.minimum(VAR62,VAR63))
    a=((((((VAR16)) ) + ( (VAR53)) ) + ( (VAR5B)) ) + ( (((((CLOSE - VAR64) / CLOSE) < 0.03) ) * (1 ))))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
