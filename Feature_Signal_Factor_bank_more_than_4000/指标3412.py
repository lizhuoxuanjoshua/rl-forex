...
#开始
    ...
    VAR1=(1)
    AB=(((3*sma((CLOSE-llv(LOW,27))/(hhv(HIGH,27)-llv(LOW,27))*100,5,1)-2*sma(sma((CLOSE-llv(LOW,27))/(hhv(HIGH,27)-llv(LOW,27))*100,5,1),3,1)-50)*1.032+50))
    VAR2=((2*CLOSE+HIGH+LOW+OPEN)/5)
    VAR3=(llv(LOW,34))
    VAR4=(hhv(HIGH,34))
    SK=( EMA((VAR2-VAR3)/(VAR4-VAR3)*100,13)*VAR1)
    SD=( EMA(SK,3))
    AA=(np.where(CROSS(AB,21),50,18.5))
