...
#开始
    ...
    MA40=(MA(MID,40))
    A40=(MA40-MA0)
    LC=((A6+A7+A8+A9+A10+A11+A12+A13+A14+A15+A16+A17+A18+A19+A20)/300)
    VAR1=(LC)
    VAR2=(REF(LC,1))
    VAR3=(VAR1>VAR2 ) * ( REF(LC,1)<REF(LC,2))
    VAR4=(VAR1<VAR2 ) * ( REF(LC,1)>REF(LC,2))
    a=(VAR1>VAR2 ) * ( REF(VAR1,1)<REF(VAR1,2))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
