...
#开始
    ...
    VAR4 =( (MA(C,20) > MA(C,60)) ) * ( ((count(MA(C,60) > REF(MA(C,60),1),10)) == 10))
    VAR5 =( (count((((MA(C,13) - MA(C,210)) / MA(C,210)) * 100) < 35,100)) >= 90)
    VAR6 =( (((REF(C,1) - MA(C,210)) / MA(C,210)) * 100) < 35)
    VAR7 =(( ((((VAR1 ) * ( VAR2) ) * ( VAR3) ) * ( (MA(C,13) > MA(C,210))) ) * ( (MA(C,210) > REF(MA(C,210),3)))) ) + ( ((((VAR5 ) * ( VAR6) ) * ( (MA(C,13) > MA(C,210))) ) * ( (MA(C,210) > REF(MA(C,210),3)))
))
    VAR8 =( MA(LOW,20) * 1.1)
    VAR9 =( ((((REF(C,1) / REF(C,6)) < 1.15)) ) + ( ((REF(C,1) < REF(C,3)))) ) + ( (((REF((hhv(HIGH,5) - llv(LOW,5)) / llv(LOW,5),1)) < 0.15)
))
    VAR10 =( (((C / REF(C,1)) > 1.05) ) * ( (C > OPEN)) ) * ( 1)
    VAR11 =( REF((((hhv(C,100) / llv(C,100)) - 1) * 100) <= 40,1))
    VAR12 =( (REF(C,1) / llv(LOW,80)) <= 1.45)
    VAR13 =( (((((CROSS(C,VAR8) ) * ( VAR7) ) * ( VAR10) ) * ( (C > REF(hhv(HIGH,120),1))) ) * ( VAR9) ) * ( VAR11) ) * ( VAR12)
    VAR14 =( VAR13 ) * ( (((REF(barslast(VAR13),1) >= 50)) ) + ( (1)))
    ...
    VAR20 =( ((((REF(C,1) - MA(C,60)) / MA(C,60)) * 100) < 35) ) * ( ((((C - MA(C,60)) / MA(C,60)) * 100) > 0))
    VAR21 =( ((((((VAR16 ) * ( VAR17) ) * ( VAR18) ) * ( (MA(C,13) > MA(C,210))) ) * ( (MA(C,210) > MA(C,250)))) ) + ( ((((VAR19 ) * ( VAR20) ) * ( (MA(C,13) > MA(C,210))) ) * ( (MA(C,210) > MA(C,250))))) ) + ( (((VAR19 ) * ( VAR20) ) * ( (MA(C,60) > MA(C,250)))
))
    VAR22 =( ((((REF(C,1) / REF(LOW,6)) < 1.15)) ) + ( ((REF(C,1) < REF(C,3)))) ) + ( (((REF((hhv(HIGH,5) - llv(LOW,5)) / llv(LOW,5),1)) < 0.15)
))
    VAR23 =( (((C / REF(C,1)) > 1.06) ) * ( (C > OPEN)) ) * ( 1)
    VAR24 =( REF((((hhv(C,14) / llv(C,14)) - 1) * 100) <= 15,1))
    VAR25 =( (REF(C,1) / llv(LOW,80)) <= 1.45)
    VAR26 =( ((hhv(HIGH,250) - llv(LOW,250)) / llv(LOW,300)) * 100)
    VAR27 =( (VAR26 > 0) ) * ( (VAR26 <= 120))
    VAR28 =( VOL)
    VAR29 =( MA(VAR28,5))
    VAR30 =( MA(VAR28,135))
    VAR31 =(( (REF((count(VAR28 > VAR30,15)) >= 10,1))) ) + ( ((REF((count(VAR29 < VAR30,7)) >= 5,1))
))
    ...
    VAR39 =( (((count(REF(VAR37,1) < REF(VAR37,2),3)) >= 1) ) * ( (VAR37 >= 0)) ) * ( (VAR37 > REF(VAR37,1)))
    VAR40 =(( VAR38) ) + ( (VAR39
))
    VAR41 =( EMA(C,2) - EMA(C,89))
    VAR42 =( EMA(VAR41,30))
    VAR43 =( (2 * (VAR41 - VAR42)) * 10)
    VAR44 =( (np.power(VAR43,3) * 0.1) + np.power(VAR43,2))
    VAR45 =( (np.where(VAR43 > 0.015,VAR44,0)) / 45)
    VAR46 =( VAR45)
    VAR47 =( EMA(C,2) - EMA(C,150))
    VAR48 =( EMA(VAR47,100))
    VAR49 =( 2 * (VAR47 - VAR48))
    VAR50 =( (np.power(VAR49,3) * 0.1) + np.power(VAR49,1))
    VAR51 =( (np.where(VAR49 > 0.1,VAR50,0)) * 5)
    VAR52 =( ((((((VAR46 > 0)) ) + ( ((VAR51 > 0))))) ) * ( (VAR46 > REF(VAR46,1))) ) * ( (VAR51 > REF(VAR51,1)))
    VAR53 =( sma(AMOUNT,10,1) / 10000000)
    VAR54 =( MA(VAR53,8))
    VAR55 =( (VAR53 >= REF(VAR53,1)) ) * ( (VAR53 > VAR54))


    VAR59 =( ((VAR35 > VAR36) ) * ( (VAR35 > 0)) ) * ( (VAR36 > 0))
    VAR60 =( (VAR52 ) * ( VAR55) ) * ( VAR59)
    VAR61 =( (((((CROSS(C,VAR8) ) * ( VAR21) ) * ( VAR25) ) * ( VAR23) ) * ( (C > REF(hhv(HIGH,50),1))) ) * ( VAR22) ) * ( VAR24)
    VAR62 =( VAR61 ) * ( (((REF(barslast(VAR61),1) > 10)) ) + ( ((1))))
    VAR63 =(( ((((VAR14 ) * ( VAR27) ) * ( VAR40) ) * ( VAR31) ) * ( VAR33)) ) + ( (((((VAR62 ) * ( VAR27) ) * ( VAR40) ) * ( VAR31) ) * ( VAR33)
))
    a =(VAR63 )
#结束
    买入 = a
