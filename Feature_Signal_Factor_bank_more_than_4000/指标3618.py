...
#开始
    ...
    RSV=((CLOSE-llv(LOW,9))/(hhv(HIGH,10)-llv(LOW,13))*2-0.5)
    K=(sma(RSV,6,1))
    D=(sma(K,3,1))
    LLJX=(3*K-2*D)
    B1=((count(LLJX,1)
    ...
    A1=(np.where(B1>REF(B1,1),B1,0))
    A2=(np.where(B2>REF(B2,1),B2,0))
    A3=(np.where(B3>REF(B3,1),B3,0))
    A4=(np.where(B4>REF(B4,1),B4,0))
    A5=(np.where(B5>REF(B5,1),B5,0))
    A6=(np.where(B6>REF(B6,1),B6,0))
    A7=(np.where(B7>REF(B7,1),B7,0))
    A8=(np.where(B8>REF(B8,1),B8,0))
    A9=(np.where(B9>REF(B9,1),B9,0))
    A10=(np.where(B10>REF(B10,1),B10,0))
    CV=(CLOSE)
