...
#开始
    ...
    VAR0 =( (((REF(C,1) < REF(OPEN,1))) ) + ( ((C <= REF(C,1)))) ) * ( ((C > OPEN) ) + ( (((C == OPEN) ) * ( (OPEN > LOW)))))
    VAR1 =( ((C > REF(C,1)) ) * ( (C < OPEN)) ) * ( (MA(C,10) > REF(MA(C,10),1)))
    VAR2 =( (C < MA(C,5)) ) * ( ((VAR0) ) + ( (VAR1)))
    VAR3 =( C > (REF(C,1) * 1.095))
    VAR4 =(( ((C > OPEN) ) * ( (VOL > (MA(VOL,120) * 3)))) ) + ( (VAR3
))
    VAR5 =( EVERY(VAR4,3) ) * ( count(VAR3,4))
    VAR6 =( count(VAR5,6) ) * ( VAR2)
    VAR7 =( count(VAR3,10) ) * ( (REF(MA(C,20),1) > (REF(MA(C,20),5) * 1.03)))
    VAR8 =( (count(C > (REF(C,1) * 1.095),5)) >= 2)
    VAR9 =( count(VAR8,5) ) * ( VAR2)
    VAR10 =( ((count(C > (REF(C,1) * 1.095),5)) ) * ( (count(C > (REF(C,2) * 1.16),5))) ) * ( (count(LOW > REF(HIGH,1),5)))
    VAR11 =( VAR10 ) * ( VAR2)
    VAR12 =( ((REF(MA(C,5),1) > (REF(MA(C,5),2) * 1.02)) ) * ( (REF(MA(C,5),1) > (REF(MA(C,5),5) * 1.1))) ) * ( (MA(C,30) > MA(C,60)))
    VAR13 =( ((REF(MA(C,10),1) > (REF(MA(C,10),2) * 1.016)) ) * ( (REF(MA(C,10),1) > (REF(MA(C,10),5) * 1.1))) ) * ( (MA(C,30) > MA(C,60)))
    VAR14 =( ((VAR12) ) + ( (VAR13)) ) * ( VAR2)
    VAR15 =( VOL > MA(VOL,120))
    VAR16 =( MA(VOL,5) > (MA(VOL,120) * 2))
    VAR17 =( ((EVERY(VAR15,15)) ) + ( (EVERY(VAR16,10))) ) * ( count(VAR3,15))
    VAR18 =( (REF(MA(C,5),1) > (REF(MA(C,5),5) * 1.03)) ) * ( (((REF(MA(C,5),1) > (REF(MA(C,5),2) * 1.01))) ) + ( ((MA(C,5) > (REF(MA(C,5),1) * 1.01)))))
    VAR19 =( (REF(MA(C,10),1) > (REF(MA(C,10),5) * 1.03)) ) * ( (((REF(MA(C,10),1) > (REF(MA(C,10),2) * 1.01))) ) + ( ((MA(C,10) > (REF(MA(C,10),1) * 1.01)))))
    VAR20 =( (((((REF(MA(C,20),1) > (REF(MA(C,20),5) * 1.03)) ) * ( (REF(MA(C,20),1) > (REF(MA(C,20),2) * 1.008))) ) * ( (MA(C,5) > MA(C,10))) ) * ( (REF(MA(C,30),1) > (REF(MA(C,30),5) * 1.03))) ) * ( (REF(MA(C,30),1) > (REF(MA(C,30),2) * 1.008))) ) * ( (MA(C,10) > (REF(MA(C,10),5) * 1.03)))
    VAR21 =( ((((((C < MA(C,5)) ) * ( (REF(MA(C,5),2) > (REF(MA(C,5),4) * 1.02))) ) * ( (REF(MA(C,5),3) > (REF(MA(C,5),5) * 1.02))) ) * ( (REF(MA(C,10),2) > (REF(MA(C,10),4) * 1.02))) ) * ( (REF(MA(C,10),3) > (REF(MA(C,10),5) * 1.02))) ) * ( (MA(C,10) > (REF(MA(C,10),2) * 1.016))) ) * ( (MA(C,20) > (REF(MA(C,20),2) * 1.006)))
    VAR22 =( ((REF(VAR18,3)) ) + ( (REF(VAR19,3))) ) * ( (REF(MA(C,5),3) > REF(MA(C,10),3)))
    VAR23 =( (((REF(C,3) > REF(MA(C,5),3))) ) + ( ((REF(C,2) > REF(MA(C,5),2)))) ) * ( (REF(C,3) > REF(MA(C,10),3)))
    VAR24 =( (C < MA(C,10)) ) * ( (MA(C,30) > (REF(MA(C,30),5) * 1.02)))
    VAR25 =( (VAR22 ) * ( VAR23) ) * ( VAR24)
    VAR26 =( ((((VAR7) ) + ( (count(VAR5,20))) ) + ( (count(VAR8,20))) ) + ( (count(VAR17,20))) ) + ( (count(VAR10,20)
))
    VAR27 =( (VAR2 ) * ( ((((VAR18) ) + ( (VAR19)) ) + ( (VAR20)) ) + ( (VAR21))) ) * ( VAR26)
    VAR28 =( VAR26 ) * ( VAR2)
    VAR29 =( (((VAR6) ) + ( (VAR14)) ) + ( (VAR11)) ) + ( (VAR27
))
    VAR30 =( VAR25 ) * ( VAR28)
