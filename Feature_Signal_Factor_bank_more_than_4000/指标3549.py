...
#开始
    ...
    A1=(REF(BIAS1,2)>REF(BIAS1,1) ) * ( REF(BIAS1,1)<BIAS1 ) * ( REF(BIAS1,2)<BIAS1)
    A2=(REF(BIAS2,2)>REF(BIAS2,1) ) * ( REF(BIAS2,1)<BIAS2 ) * ( REF(BIAS2,2)<BIAS2)
    A3=(REF(BIAS3,2)>REF(BIAS3,1) ) * ( REF(BIAS3,1)<BIAS3 ) * ( REF(BIAS3,2)<BIAS3)
    a=(A1 ) * ( A2 ) * ( A3)
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
