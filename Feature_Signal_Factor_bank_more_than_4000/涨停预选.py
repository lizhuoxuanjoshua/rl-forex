...
#开始
    ...
    涨停=(C-REF(C,1))/REF(C,1)>=0.095

    曾涨停=(H-REF(C,1))/REF(C,1)>=0.095

    

    情况1=(((count((涨停 + 曾涨停),5)>=2) + (count((涨停 + 曾涨停),7)>=3) + (count(涨停 ,8)>=2))) *  (count(涨停,8)>=2)

    情况2=(count((涨停 + 曾涨停),5)>=2) * (count(涨停,10)>=2)

    情况3=count((涨停 + 曾涨停),13)>=4
