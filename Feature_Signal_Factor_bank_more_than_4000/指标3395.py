...
#开始
    ...
    VARTIME=(1)
    VARDTIME=(1)
    Q1=((CLOSE-REF(CLOSE, 1))/REF(CLOSE, 1)*100*VARTIME)
    Q2=((CLOSE-llv(LOW, 18))/(hhv(HIGH, 18)-llv(LOW, 18))*VARTIME*100)
    Q3=(sma(Q2, 9, 1)*VARTIME)
    Q4=(sma(Q3, 3, 1)*VARTIME)
    AA=(3*Q3-2*Q4)
    散筹1=(EMA(Q3, 3) )
    散筹2=(EMA(散筹1, 3) )
    散筹3=(EMA(散筹2, 3) )
