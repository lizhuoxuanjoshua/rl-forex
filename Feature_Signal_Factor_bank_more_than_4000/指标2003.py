...
#开始
    ...
    OK2=(REF(MA(C,5),1)>=MA(C,5) ) * ( REF(MA(C,5),2)>=REF(MA(C,5),1)*1.012 ) * ( MA(C,10)>REF(MA(C,10),1) ) * ( MA(C,5)<=MA(C,10) ) * ( REF(C,1)>REF(C,2)*0.95 ) * ( C>REF(O,1) ) * ( C<=REF(C,1)*1.02 ) * ( C>REF(C,1)*0.97 ) * ( REF(100*(H-L)/REF(C,5),5)<5)
    OK3=(REF(MA(C,5),1)>=MA(C,5) ) * ( REF(MA(C,5),2)>=REF(MA(C,5),1) ) * ( MA(C,10)>REF(MA(C,10),1) ) * ( MA(C,5)>=MA(C,10) ) * ( C>REF(C,1)*0.97 ) * ( C>REF(O,1) ) * ( H<REF(hhv(H,2),1) ) * ( REF(100*(H-L)/REF(C,5),5)<5 ) * ( REF(C,1)>REF(C,2)*0.95)
    OK4=(REF(MA(C,5),2)>=REF(MA(C,5),1) ) * ( MA(C,5)>=REF(MA(C,5),1) ) * ( MA(C,10)>=REF(MA(C,10),1) ) * ( MA(C,10)<=MA(C,5) ) * ( REF(MA(C,10),1)<REF(MA(C,5),1) ) * ( MA(C,5)<=MA(C,10)*1.01 ) * ( C>REF(C,1)*0.97 ) * ( L>=llv(L,5) ) * ( C<=REF(C,1)*1.03 ) * ( H<=REF(hhv(H,5),1 ) * ( REF(C,1)>REF(C,2)*0.95 ) * ( REF(100*(H-L)/REF(C,5),5)<5))
    OK5=(REF(MA(C,5),1)>=MA(C,5) ) * ( REF(MA(C,5),2)>=REF(MA(C,5),1) ) * ( MA(C,10)>REF(MA(C,10),1) ) * ( MA(C,5)>=MA(C,10) ) * ( L>=llv(L,5) ) * ( C<=REF(C,1)*1.03 ) * ( C>REF(C,1)*0.97 ) * ( REF(C,1)>REF(C,2)*0.95 ) * ( REF(100*(H-L)/REF(C,5),5)<5)
    OK6=(REF(MA(C,5),1)>=MA(C,5) ) * ( REF(MA(C,5),2)>=REF(MA(C,5),1) ) * ( MA(C,10)>=REF(MA(C,10),1) ) * ( CROSS(MA(C,10),MA(C,5)) ) * ( C<REF(C,1)*1.03 ) * ( L>=llv(L,5) ) * ( C>REF(C,1)*0.97 ) * ( REF(C,1)>REF(C,2)*0.95 ) * ( REF(100*(H-L)/REF(C,5),5)<5)
    a=((OK2) ) + ( (OK3) ) + ( (OK4) ) + ( (OK5) ) + ( (OK6))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
