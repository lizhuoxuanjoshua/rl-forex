...
#开始
    ...
    XA_1=(REF(CLOSE,2)<REF(CLOSE,1)*0.998)
    ...
    a=(XA_1 ) * ( XA_9 ) * ( XA_9 ) * ( XA_10 ) * ( XA_10 ) * ( XA_18 ) * ( XA_20 ) * ( XA_19 ) * ( XA_27 ) * ( XA_27 ) * ( XA_28 ) * ( XA_30 ) * ( XA_32 ) * ( XA_38 ) * ( XA_39 ) * ( XA_41 ) * ( XA_42 ) * ( XA_43)
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
