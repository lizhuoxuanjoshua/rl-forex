...
#开始
    ...
    VAR13=((VAR11>=150 ) * ( VAR11<200 ) * ( VAR12>=150 ) * ( VAR12<200))*10
    VAR14=((VAR11<=-150 ) * ( VAR11>-200 ) * ( VAR12<=-150 ) * ( VAR12>-200))*-10
    VAR15=((CLOSE-MA(CLOSE,11))/MA(CLOSE,11)*100)
    VAR16=(100-np.abs(VAR15))
    VAR17=(np.where(VAR16<90,VAR16,100))
    VAR1A=(np.where(VARE>0,VARE,0))

    VAR1C=(VAR1A>48 )  * ( VAR17<100)
    a=(VAR1C ) * ( count(VAR1C,30)==1)
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
