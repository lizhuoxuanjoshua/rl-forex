...
#开始
    ...
    超短强度=(np.arctan((MA(C,5)/REF(MA(C,5),1)-1)*100)*57.3)
    短期强度=(np.arctan((MA(C,13)/REF(MA(C,13),1)-1)*100)*57.3)
    中期强度=(np.arctan((MA(C,20)/REF(MA(C,20),1)-1)*100)*57.3)
    长期强度=(np.arctan((MA(C,60)/REF(MA(C,60),1)-1)*100)*57.3)
