...
#开始
    ...
    X_1=(np.where(hhv(np.abs(hhv(CLOSE,6)/llv(CLOSE,6)-1),6)>10/100,3,6))
    X_3=(VOL<MA(VOL,5) ) * ( MA(VOL,5)<MA(VOL,55))
    X_4=(CLOSE/REF(CLOSE,1)>1.025)
    X_5=(MA(CLOSE,10)>CLOSE*1.05)
    X_6=(MA(CLOSE,10)<CLOSE*1.1)
    X_7=(MA(CLOSE,60)>CLOSE*1.28)
