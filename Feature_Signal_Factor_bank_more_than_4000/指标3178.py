...
#开始
    ...
    X_8=(CROSS(PDI,37))
    X_9=(CROSS(X_1,X_2))
    X_10=(VOL/REF(VOL,1)>1.05)
    X_11=(VOL/REF(VOL,1)>1.5)
    X_12=(VOL/REF(VOL,1)>2)
    X_13=(VOL/REF(VOL,1)>5)
    X_14=(VOL/REF(VOL,1)>2.5)
    X_15=(VOL/REF(VOL,2)>2 ) * ( VOL/REF(VOL,1)>1.3)
    X_16=(CLOSE>REF(CLOSE,1))
    X_17=(CLOSE/REF(CLOSE,1)>1.02)
    X_18=(CLOSE/REF(CLOSE,1)>1.09)
    X_19=(CLOSE==hhv(CLOSE,15))
    X_20=(X_6 ) * ( X_11 ) * ( X_17)
    X_21=(X_3 ) * ( X_4 ) * ( X_5 ) * ( X_11 ) * ( X_17)
    X_22=(X_4 ) * ( X_6 ) * ( X_12 ) * ( X_17 ) * ( X_19)
    X_23=(X_3 ) * ( X_6 ) * ( X_13 ) * ( X_17 ) * ( X_19)
    X_24=(X_3 ) * ( X_7 ) * ( X_12 ) * ( X_17 ) * ( X_19)
    X_25=(X_3 ) * ( X_4 ) * ( X_8 ) * ( X_14 ) * ( X_17 ) * ( X_19)
    X_26=(X_3 ) * ( X_4 ) * ( X_7 ) * ( X_15 ) * ( X_17 ) * ( X_19)
    X_27=(X_3 ) * ( X_4 ) * ( X_9 ) * ( X_10 ) * ( X_18 ) * ( X_19)
    a=(X_22 ) + ( X_23)  + ( X_24)  + ( X_25)  + ( X_26)  + ( X_27)
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
