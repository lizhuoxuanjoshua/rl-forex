...
#开始
    ...
    E0=(C)
    E1=(EMA(JJ,3))
    E3=(EMA(EMA(EMA(JJ,3),3),3))
    E5=(EMA(EMA(EMA(EMA(EMA(JJ,3),3),3),3),3))
    E8=(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(JJ,3),3),3),3),3),3),3),3))
    E13=(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(JJ,3),3),3),3),3),3),3),3),3),3),3),3),3))
    E21=(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(JJ,3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3))
    E34=((EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(JJ,3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3)
))
    E55=(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(EMA(JJ,3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3),3))
    ...
    VARC=(MA(VARB,34))
    VARD=(MA(CLOSE,26))
    阻力=VARD+2*STD(CLOSE,34)
    支持=VARD-2*STD(CLOSE,26)
    AA=(E55>支持 ) * ( E34>支持 ) * ( E21>支持 ) * ( E13>支持 ) * ( E8>支持 ) * ( E5>支持) * ( E55<阻力 ) * ( E34<阻力 ) * ( E21<阻力 ) * ( E13<阻力 ) * ( E8<阻力 ) * ( E5<阻力)
    a=(CROSS(C,阻力) ) * ( AA)
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
