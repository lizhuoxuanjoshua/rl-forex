...
#开始
    ...
    C11=((np.arctan((C-REF(C,1))/REF(C,1)/0.1)))
    C12=((np.arctan((C-REF(C,2))/REF(C,2)/0.2)))
    C13=((np.arctan((C-REF(C,3))/REF(C,3)/0.3)))
    C4=((np.arctan((C-REF(C,4))/REF(C,4)/0.4)))
    C5=((np.arctan((C-REF(C,5))/REF(C,5)/0.5)))
    C6=((np.arctan((C-REF(C,6))/REF(C,6)/0.6)))
    C7=((np.arctan((C-REF(C,7))/REF(C,7)/0.7)))
    C8=((np.arctan((C-REF(C,8))/REF(C,8)/0.8)))
    C9=((np.arctan((C-REF(C,9))/REF(C,9)/0.9)))
    C10=((np.arctan((C-REF(C,10))/REF(C,10)/1)))
    CJD=(MA((C11+C12+C13+C4+C5+C6+C7+C8+C9+C10)/10/6.28*360,1))
    O1=((np.arctan((O-REF(O,1))/REF(O,1)/0.1)))
    O2=((np.arctan((O-REF(O,2))/REF(O,2)/0.2)))
    O3=((np.arctan((O-REF(O,3))/REF(O,3)/0.3)))
    O4=((np.arctan((O-REF(O,4))/REF(O,4)/0.4)))
    O5=((np.arctan((O-REF(O,5))/REF(O,5)/0.5)))
    O6=((np.arctan((O-REF(O,6))/REF(O,6)/0.6)))
    O7=((np.arctan((O-REF(O,7))/REF(O,7)/0.7)))
    O8=((np.arctan((O-REF(O,8))/REF(O,8)/0.8)))
    O9=((np.arctan((O-REF(O,9))/REF(O,9)/0.9)))
    O10=((np.arctan((O-REF(O,10))/REF(O,10)/1)))
    OJD=(MA((O1+O2+O3+O4+O5+O6+O7+O8+O9+O10)/10/6.28*360,1))
    CO和=(MA(REF(CJD+OJD,1),3))
    CD3=(MA(CJD,3))
