...
#开始
    ...
    超跌1=(BIAS21<=-17 ) * ( BIAS21<=REF(BIAS21,1))
    阻击1=(REF(超跌1,1) ) * ( BIAS21>REF(BIAS21,1))
    BIAS20=((CLOSE-MA(CLOSE,20))/MA(CLOSE,20)*100)
    超跌2=(BIAS20<=-17 ) * ( BIAS20<=REF(BIAS20,1))
    阻击2=(REF(超跌2,1) ) * ( BIAS20>REF(BIAS20,1))
    BIAS19=((CLOSE-MA(CLOSE,19))/MA(CLOSE,19)*100)
    超跌3=(BIAS19<=-17 ) * ( BIAS19<=REF(BIAS19,1))
    阻击3=(REF(超跌3,1) ) * ( BIAS19>REF(BIAS19,1))
    BIAS18=((CLOSE-MA(CLOSE,18))/MA(CLOSE,18)*100)
    超跌4=(BIAS18<=-16 ) * ( BIAS18<=REF(BIAS18,1))
    阻击4=(REF(超跌4,1) ) * ( BIAS18>REF(BIAS18,1))
    BIAS17=((CLOSE-MA(CLOSE,17))/MA(CLOSE,17)*100)
    超跌5=(BIAS17<=-16 ) * ( BIAS17<=REF(BIAS17,1))
    阻击5=(REF(超跌5,1) ) * ( BIAS17>REF(BIAS17,1))
    BIAS16=((CLOSE-MA(CLOSE,16))/MA(CLOSE,16)*100)
    超跌6=(BIAS16<=-16 ) * ( BIAS16<=REF(BIAS16,1))
    阻击6=(REF(超跌6 ,1) ) * ( BIAS16>=REF(BIAS16,1))
    BIAS15=((CLOSE-MA(CLOSE,15))/MA(CLOSE,15)*100)
    超跌7=(BIAS15<=-14 ) * ( BIAS15<=REF(BIAS15,1))
    阻击7=(REF(超跌7,1) ) * ( BIAS15>REF(BIAS15,1))
    BIAS14=((CLOSE-MA(CLOSE,14))/MA(CLOSE,14)*100)
    超跌8=(BIAS14<=-14 ) * ( BIAS14<=REF(BIAS14,1))
    阻击8=(REF(超跌8,1) ) * ( BIAS14>REF(BIAS14,1))
    BIAS13=((CLOSE-MA(CLOSE,13))/MA(CLOSE,13)*100)
    超跌9=(BIAS13<=-13 ) * ( BIAS13<=REF(BIAS13,1))
    阻击9=(REF(超跌9 ,1) ) * ( BIAS13>REF(BIAS13,1))
    BIAS12=((CLOSE-MA(CLOSE,12))/MA(CLOSE,12)*100)
    超跌10=(BIAS12<=-13 ) * ( BIAS12<=REF(BIAS12,1))
    阻击10=(REF(超跌10,1) ) * ( BIAS12>REF(BIAS12,1))
    BIAS11=((CLOSE-MA(CLOSE,11))/MA(CLOSE,11)*100)
    超跌11=(BIAS11<=-13 ) * ( BIAS11<=REF(BIAS11,1))
    阻击11=(REF(超跌11,1) ) * ( BIAS11>REF(BIAS11,1))
    BIAS10=((CLOSE-MA(CLOSE,10))/MA(CLOSE,10)*100)
    超跌12=(BIAS10<=-12 ) * ( BIAS10<=REF(BIAS10,1))
    阻击12=(REF(超跌12,1) ) * ( BIAS10>REF(BIAS10,1))
    BIAS9=((CLOSE-MA(CLOSE,9))/MA(CLOSE,9)*100)
    超跌13=(BIAS9<=-12 ) * ( BIAS9<=REF(BIAS9,1))
    阻击13=(REF(超跌13,1) ) * ( BIAS9>REF(BIAS9,1))
    a=(( 阻击1) ) + ( (阻击2) ) + ( (阻击3) ) + ( (阻击4) ) + ( (阻击5) ) + ( (阻击6) ) + ( (阻击7) ) + ( (阻击8) ) + ( (阻击9) ) + ( (阻击10) ) + ( (阻击11) ) + ( (阻击12) ) + ( (阻击13))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
