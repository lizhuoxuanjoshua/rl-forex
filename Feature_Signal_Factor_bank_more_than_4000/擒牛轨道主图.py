...
#开始
    ...
    AA=np.where(K==0,(8*AAAX+7*REF(AAAX,1)+6*REF(AAAX,2)+5*REF(AAAX,3)

    

    +4*REF(AAAX,4)+3*REF(AAAX,5)+2*REF(AAAX,6)+REF(AAAX,8))/36,0)
    ...
    箱底=np.where(K==1 ,MA(REF(llv(C,30),1),2),0)
