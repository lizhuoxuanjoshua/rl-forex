...
#开始
    ...
    VA1=(REF(O,2)>REF(H,3) ) * ( REF(O,2)>REF(C,2) ) * ( REF(V,2)>REF(V,3)*2 ) * ( REF(V,2)==hhv(REF(V,2),30))
    VB1=(REF(O,3)>REF(H,4) ) * ( REF(O,3)>REF(C,3) ) * ( REF(V,3)>REF(V,4)*2 ) * ( REF(V,3)==hhv(REF(V,3),30))
    VA2=(L<MA(C,10) ) * ( C>MA(C,10) ) * ( C>O ) * ( ((O/L>1.01) ) + ( (C/O>1.03)))
    VA3=(REF(L,1)<REF(MA(C,5),1) ) * ( C>MA(C,60)) * ( C>MA(C,120))
    VA4=(MA(C,5)>MA(C,10) ) * ( MA(C,10)>MA(C,20))
    VXG1=(((VA1) ) + ( (VB1)) ) * ( VA2 ) * ( VA3 ) * ( VA4)
    VP1=(REF(O,3)>REF(H,4) ) * ( REF(O,3)>REF(C,3) ) * ( REF(V,3)>REF(V,4)*2 ) * ( REF(O,3)/REF(C,3)>1.03)
    VP2=(O<MA(C,5) ) * ( REF(L,1)<REF(MA(C,5),1) ) * ( C>MA(C,5) ) * ( MA(C,5)>MA(C,10) ) * ( MA(C,10)>MA(C,20)) * ( C/REF(C,1)>1.03 ) * ( L/MA(C,10)<1.01)
    VXG2=(VP1 ) * ( VP2)
    VQ1=(REF(O,2)>REF(H,3) ) * ( REF(O,2)>REF(C,2) ) * ( REF(V,2)>REF(V,3)*2 ) * ( REF(V,2)==hhv(REF(V,2),30))
    VQ2=(O<MA(C,5) ) * ( C>MA(C,5) ) * ( C>O) * ( MA(C,5)>MA(C,10) ) * ( MA(C,10)>MA(C,20) ) * ( MA(C,20)>MA(C,30) ) * ( MA(C,30)>MA(C,60))
    VXG3=(VQ1 )
    a=(((VXG1) ) + ( (VXG2) ) + ( (VXG3)))
#结束
    买入 = a
