...
#开始
    ...
    BGB0=((C-REF(C,1)>0) ) + ( ((C-REF(C,1)==0 ) * ( C>O)
))
    BGB1=((C-REF(C,1)<0) ) + ( ((C-REF(C,1)==0 ) * ( C<=O)
))
    BGB2=(BGB0 ) * ( REF(BGB0,1) ) * ( REF(BGB0,2))
    BGB3=(BGB0 ) * ( REF(BGB0,1) ) * ( REF(BGB1,2))
    BGB4=(BGB0 ) * ( REF(BGB1,1) ) * ( REF(BGB0,2))
    BGB5=(BGB0 ) * ( REF(BGB1,1) ) * ( REF(BGB1,2))
    BGB6=(BGB1 ) * ( REF(BGB0,1) ) * ( REF(BGB0,2))
    BGB7=(BGB1 ) * ( REF(BGB0,1) ) * ( REF(BGB1,2))
    BGB8=(BGB1 ) * ( REF(BGB1,1) ) * ( REF(BGB0,2))
    BGB9=(BGB1 ) * ( REF(BGB1,1) ) * ( REF(BGB1,2))
    a=BGB0
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
