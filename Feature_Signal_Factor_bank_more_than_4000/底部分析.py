...
#开始
    ...
    多头1=(DEA102>0) * (DEA51>0)

    

    多头2=(DEA102>0) * (DEA66>DEA12) * (DEA12>DEA18)

    

    多头3=(DEA18>DEA51) * (DEA18>DEA102) * (DEA18>0)

    

    多头=((多头1==1)) + ((多头2==1)) + ((多头3==1)
)
    

    空头1=((DEA18>DEA51)) + ((DEA18>DEA102)
)
