...
#开始
    ...
    V00=( HIGH<REF(HIGH,1) ) * ( LOW<REF(LOW,1))
    V01=( HIGH<REF(HIGH,1) ) * ( LOW>REF(LOW,1))
    V02=( HIGH>REF(HIGH,1) ) * ( LOW<REF(LOW,1))
    V03=( HIGH>REF(HIGH,1) ) * ( LOW>REF(LOW,1))
    V04=( REF(HIGH,2) < HIGH ) * ( REF(LOW,2) < LOW) * ( REF(HIGH,2) > REF(HIGH,1) ) * ( REF(LOW,2) < REF(LOW,1))
    V1=( count(V00,6)>=3 ) *  ( V03)
    V2=( count(V00,7)>=3 ) * ( V04)
    V3=( count(V00,7)>=3 ) * ( V03)
    V4=( count(V00,8)>=3 ) * ( V04)
    V5=( count(V00,8)>=3 ) * ( V03)
    V6=( count(V00,9)>=3 ) * ( V04)
    V7=( count(V00,9)>=3 ) * ( V03)
    V8=( count(V00,10)>=3 )   * ( V04)
    V9=( count(V00,10)>=3 )  * ( V03)
    V10=( count(V00,11)>=3 )   * ( V04)
    XG=(( V1) ) + ( (V2) ) + ( (V3) ) + ( (V4) ) + ( (V5) ) + ( (V6) ) + ( (V7) ) + ( (V8) ) + ( (V9) ) + ( (V10
))
    a=(FILTER(XG==1,5))
#结束
    买入 = a
