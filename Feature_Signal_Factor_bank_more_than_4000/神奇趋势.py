...
#开始
    ...
    A66=count(CROSS(A64,A65),4) * (A64>REF(A64,1)) * (A65>REF(A65,1))
    ...
    A71=count(np.maximum(0,HIGH-A70),26)/count(np.maximum(0,A70-LOW),26)*100
    ...
    A76=(A71>A72) * (A71>A73) * (A71>A74) * (A71>A75)
