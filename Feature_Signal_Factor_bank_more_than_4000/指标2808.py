...
#开始
    ...
    VAR3=(MA1>MA3)
    VAR4=(MA2>MA3)
    VAR5=(((C-REF(C,4))/5)+MA1)
    VAR6=(((C-REF(C,9))/10)+MA2)
    VAR7=(CROSS(VAR5,VAR6))
    VAR8=(CROSS(MA1,MA2))
    VAR9=(VAR1 ) * ( VAR2 ) * ( VAR3 ) * ( VAR7)
    VAR10=(VAR1 ) * ( VAR4 ) * ( VAR8)
    VAR11=(MA1>MA2)
    VAR12=(MA2>MA3)
    VAR13=(MA3>MA4)
    VAR14=(CROSS(VAR6,VAR5))
    VAR15=(CROSS(MA2,MA1))
    VAR17=(VAR12 ) * ( VAR13 ) * ( VAR15 ) * ( C>MA3)
    a=((VAR10) ) + ( (VAR17))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
