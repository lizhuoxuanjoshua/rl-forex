...
#开始
    ...
    VAR40=(((((((VAR6 >= VAR7) ) * ( (VAR6 >= VAR8)) ) * ( (CLOSE > OPEN))) + 买盘) / 2))
    VAR41=((((((VAR7 > VAR6) ) * ( (VAR7 > VAR8))) + 买盘) / 2))
    VAR42=((((((VAR8 > VAR6) ) * ( (VAR8 > VAR7))) + 买盘) / 2))
    VAR50=(((((((VAR6 >= VAR7) ) * ( (VAR6 >= VAR8)) ) * ( (CLOSE < OPEN))) + 卖盘) / 2))
    三日上攻=(((((VAR40 + VAR41) + VAR42) / 3)))
    三日下攻=((VAR50))
    上攻均量=((买盘))
    a=(量比 > 1) * ((买盘 / 三日上攻) > 1.58)  * (三日上攻 > 三日下攻)
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
