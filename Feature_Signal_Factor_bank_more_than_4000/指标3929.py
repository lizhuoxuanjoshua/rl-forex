...
#开始
    ...
    XA_1=(REF(CLOSE,3)/REF(CLOSE,4)>1.09)
    XA_2=(CLOSE/REF(CLOSE,1)>=1.031 ) * ( BETWEEN(OPEN/REF(OPEN,3),1.1,0.91) ) * ( LOW<REF(CLOSE,3) ) * ( REF(CLOSE,1)/REF(CLOSE,2)<0.965 ) * ( REF(CLOSE,1)<REF(OPEN,1) ) * ( NOT(REF(HIGH,2)/REF(CLOSE,3)>1.09 ) * ( REF(HIGH,2)/np.maximum(REF(CLOSE,2),REF(OPEN,2))>1.07) ) * ( NOT(REF(CLOSE,2)<REF(OPEN,2) ) * ( REF(OPEN,2)/REF(CLOSE,3)>1.09))
    XA_3=(XA_1 ) * ( XA_2)
    XA_4=(REF(CLOSE,4)/REF(CLOSE,5)>1.09 ) * ( REF(CLOSE,4)==REF(HIGH,4))
    XA_5=(CLOSE/REF(CLOSE,1)>=1.031 ) * ( BETWEEN(OPEN/REF(OPEN,4),1.1,0.91) ) * ( LOW<REF(CLOSE,4) ) * ( REF(CLOSE,1)/REF(CLOSE,2)<0.96 ) * ( REF(CLOSE,1)<REF(OPEN,1))
    XA_6=(NOT(REF(OPEN,3)/REF(CLOSE,3)>1.07 ) * ( REF(OPEN,3)>REF(CLOSE,4) ) * ( REF(CLOSE,3)<REF(LOW,4)))
    XA_7=(XA_4 ) * ( XA_5 ) * ( XA_6)
    XA_8=(REF(CLOSE,5)/REF(CLOSE,6)>1.09 ) * ( REF(CLOSE,5)==REF(HIGH,5))
    XA_9=(CLOSE/REF(CLOSE,1)>=1.031 ) * ( BETWEEN(OPEN/REF(OPEN,5),1.1,0.91) ) * ( LOW<REF(CLOSE,5) ) * ( REF(CLOSE,1)/REF(CLOSE,2)<0.96 ) * ( REF(CLOSE,1)<REF(OPEN,1) ) * ( NOT(REF(HIGH,4)/REF(CLOSE,5)>1.05 ) * ( REF(HIGH,4)/np.maximum(REF(CLOSE,4),REF(OPEN,4))>1.07) ) * ( NOT(REF(LOW,4)/REF(CLOSE,5)>1.02 ) * ( REF(CLOSE,4)<REF(OPEN,4) ) * ( MA(CLOSE,10)/OPEN>1.03 ) * ( REF(OPEN,1)<REF(MA(CLOSE,10),1)) ) * ( NOT(REF(OPEN,3)/REF(CLOSE,3)>1.07 ) * ( REF(OPEN,3)>REF(CLOSE,4) ) * ( REF(CLOSE,3)<REF(LOW,4) ) * ( REF(CLOSE,4)/REF(CLOSE,5)>1.09))
    XA_10=(XA_8 ) * ( XA_9)
    XA_11=(REF(CLOSE,6)/REF(CLOSE,7)>1.09 ) * ( REF(CLOSE,6)==REF(HIGH,6))
    XA_12=(CLOSE/REF(CLOSE,1)>=1.031 ) * ( BETWEEN(OPEN/REF(OPEN,6),1.08,0.95) ) * ( LOW<REF(CLOSE,6) ) * ( REF(CLOSE,1)/REF(CLOSE,2)<0.96 ) * ( REF(CLOSE,1)<REF(OPEN,1) ) * ( MA(CLOSE,5)>MA(CLOSE,10) ) * ( MA(CLOSE,10)>MA(CLOSE,20) ) * ( MA(CLOSE,20)>MA(CLOSE,30) ) * ( MA(CLOSE,30)>MA(CLOSE,60))
    XA_13=(XA_11 ) * ( XA_12)
    XA_14=(REF(CLOSE,3)/REF(CLOSE,4)>1.09)
    XA_15=(CLOSE/REF(CLOSE,1)>=1.031 ) * ( BETWEEN(OPEN/REF(OPEN,3),1.1,0.91) ) * ( LOW<REF(CLOSE,3) ) * ( EVERY(MA(CLOSE,5)>MA(CLOSE,10),4) ) * ( BETWEEN(REF(OPEN,1)/REF(MA(CLOSE,5),1),1.01,0.99))
    XA_16=(XA_14 ) * ( XA_15)
    XA_17=((XA_3) ) + ( (XA_7) ) + ( (XA_10) ) + ( (XA_16
))
    XA_18=(REF(CLOSE,4)/REF(CLOSE,5)>1.09 ) * ( REF(CLOSE,4)==REF(HIGH,4))
    XA_19=(CLOSE/REF(CLOSE,1)>=1.031 ) * ( REF(CLOSE,1)<REF(CLOSE,4) ) * ( BETWEEN(REF(CLOSE,1)/REF(CLOSE,2),1.015,0.985) ) * ( OPEN<REF(CLOSE,4) ) * ( OPEN<MA(CLOSE,5) ) * ( EVERY(REF(MA(CLOSE,5),1)>REF(MA(CLOSE,10),1),2))
    XA_20=(REF(HIGH,1)>REF(CLOSE,1))
    XA_21=(NOT(REF(CLOSE,1)>REF(OPEN,1) ) * ( REF(CLOSE,1)/REF(OPEN,1)>1.03))
    XA_22=(XA_18 ) * ( XA_19 ) * ( XA_20 ) * ( XA_21)
    XA_23=(REF(CLOSE,3)/REF(CLOSE,4)>1.09 ) * ( REF(CLOSE,3)==REF(HIGH,3))
    XA_24=(CLOSE/REF(CLOSE,1)>=1.031 ) * ( REF(CLOSE,1)<REF(CLOSE,3) ) * ( (REF(CLOSE,1)/REF(CLOSE,2)<0.96 ) * ( REF(CLOSE,1)<REF(OPEN,1) ) * ( REF(OPEN,1)/REF(CLOSE,1)<1.01) ) * ( OPEN<REF(CLOSE,3) ) * ( OPEN<MA(CLOSE,5) ) * ( EVERY(REF(MA(CLOSE,5),1)>REF(MA(CLOSE,10),1),2))
    XA_25=(REF(HIGH,1)>REF(CLOSE,1))
    XA_26=(XA_23 ) * ( XA_24 ) * ( XA_25)
    XA_27=(REF(CLOSE,3)/REF(CLOSE,4)>1.09 ) * ( REF(CLOSE,3)==REF(HIGH,3))
    XA_28=(CLOSE/REF(CLOSE,1)>=1.031 ) * ( REF(CLOSE,1)<REF(CLOSE,3) ) * ( (REF(CLOSE,1)<REF(OPEN,1) ) * ( REF(OPEN,1)/REF(CLOSE,1)<1.01) ) * ( OPEN<REF(CLOSE,3) ) * ( OPEN<MA(CLOSE,5) ) * ( EVERY(REF(MA(CLOSE,5),1)>REF(MA(CLOSE,10),1),3))
    XA_29=(REF(HIGH,1)>REF(CLOSE,1))
    XA_30=(XA_27 ) * ( XA_28 ) * ( XA_29)
    XA_31=(NOT(REF(CLOSE,4)/REF(CLOSE,5)>1.095 ) * ( REF(CLOSE,3)/REF(CLOSE,4)<0.92 ) * ( REF(OPEN,3)>REF(CLOSE,4) ) * ( REF(CLOSE,3)<REF(OPEN,4)))
    XA_32=((XA_22) ) + ( (XA_26) ) + ( (XA_30 ))
    a=(XA_17 ) + ( XA_32
)
#结束
    买入 = a
