...
#开始
    ...
    LC=(REF(CLOSE,1))
    RSI1A=(sma(np.maximum(CLOSE-LC,0),2,1)/sma(np.abs(CLOSE-LC),2,1)*100)
    RSI2A=(sma(np.maximum(CLOSE-LC,0),3,1)/sma(np.abs(CLOSE-LC),3,1)*100)
    RSI3A=(sma(np.maximum(CLOSE-LC,0),4,1)/sma(np.abs(CLOSE-LC),4,1)*100)
    RSI4=(sma(np.maximum(CLOSE-LC,0),5,1)/sma(np.abs(CLOSE-LC),5,1)*100)
    RSI5A=(sma(np.maximum(CLOSE-LC,0),6,1)/sma(np.abs(CLOSE-LC),6,1)*100)
    ...
    AARSI=((RSI1A+RSI2A+RSI3A+RSI4+RSI5A)/5)
    AAARSI=((RSI6+ RSI7+ RSI8+ RSI9+ RSI10+ RSI11+ RSI12+ RSI13+ RSI14+ RSI15+ RSI16+ RSI17+ RSI18+ RSI19+ RSI21)/15)
    a=(CROSS(AARSI,AAARSI))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
