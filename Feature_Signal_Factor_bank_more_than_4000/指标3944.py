...
#开始
    ...
    TC3=(REF(C,1))
    涨停=(np.where((((C - TC3) * 100) / TC3) >= (10 - ((0.03 * 100) / TC3)),1,0))
    跌停=(np.where((((TC3 - C) * 100) / TC3) >= (10 - ((0.03 * 100) / TC3)),1,0))
    VAR2=(CLOSE * VOL)
    ...
    D24=(sma(K24,3,1))
    J24=((3 * K24) - (2 * D24))
    压力位=(np.where(CROSS(J24,J),HIGH,REF(HIGH,barslast(CROSS(J24,J)))))
    DF=(BETWEEN(CLOSE / REF(CLOSE,1),1.0983,1.110))
    Z=((O + H) / 2)
    B1=(((REF(C,3) / REF(C,4)) > 1.09) ) * ( (REF(C,3) > REF(O,3)))
    B2=((((H / REF(C,1)) >= 1.041) ) * ( ((((O / REF(O,3)) < 1.05)) ) + ( (((REF(O,1) / REF(O,3)) < 1.05)))) ) * ( ((REF(C,3) / O) > 1.02))
    XG2=(B1 ) * ( B2)
    C1=(((REF(C,4) / REF(C,5)) > 1.09) ) * ( (REF(C,4) > REF(O,4)))
    C2=((((H / REF(C,1)) >= 1.041) ) * ( ((((O / REF(O,4)) < 1.05)) ) + ( (((REF(O,1) / REF(O,4)) < 1.05)))) ) * ( (O < REF(C,4)))
    C3=((REF(C,4) / O) > 1.02)
    XG3=((C1 ) * ( C2) ) * ( C3)
    D1=(((REF(C,5) / REF(C,6)) > 1.09) ) * ( (REF(C,5) > REF(O,5)))
    D2=(((H / REF(C,1)) > 1.041) ) * ( (BETWEEN(O / REF(O,5),1.05,0.85)))
    XG4=(D1 ) * ( D2)
    E1=(((REF(C,6) / REF(C,7)) > 1.09) ) * ( (REF(C,6) > REF(O,6)))
    E2=(((H / REF(C,1)) > 1.041) ) * ( (BETWEEN(O / REF(O,6),1.05,0.85)))
    XG5=(E1 ) * ( E2)
    F1=(((REF(C,7) / REF(C,8)) > 1.095) ) * ( (REF(C,7) > REF(O,7)))
    F2=(((H / REF(C,1)) > 1.041) ) * ( (BETWEEN(O / REF(O,7),1.05,0.85)))
    XG6=(F1 ) * ( F2)
    G1=(((REF(C,8) / REF(C,9)) > 1.095) ) * ( (REF(C,8) > REF(O,8)))
    G2=(((H / REF(C,1)) > 1.041) ) * ( (BETWEEN(O / REF(O,8),1.05,0.85)))
    XG7=(G1 ) * ( G2)
    H1=(((REF(C,9) / REF(C,10)) > 1.095) ) * ( (REF(C,9) > REF(O,9)))
    H2=(((C / REF(C,1)) > 1.041) ) * ( (BETWEEN(O / REF(O,9),1.05,0.92)))
    H3=(((CROSS(C,MA(C,5)) ) * ( CROSS(C,MA(C,10))) ) * ( (MA(C,10) > MA(C,20))) ) * ( (MA(C,5) > MA(C,20)))
    XG8=((H1 ) * ( H2) ) * ( H3)
    J1=(((REF(C,10) / REF(C,11)) > 1.095) ) * ( (REF(C,10) > REF(O,10)))
    J2=(((C / REF(C,1)) > 1.041) ) * ( (BETWEEN(O / REF(O,10),1.05,0.92)))
    J3=(((CROSS(C,MA(C,5)) ) * ( CROSS(C,MA(C,10))) ) * ( (MA(C,10) > MA(C,20))) ) * ( (MA(C,5) > MA(C,20)))
    XG9=((J1 ) * ( J2) ) * ( J3)
    L1=(((REF(C,11) / REF(C,12)) > 1.095) ) * ( (REF(C,11) > REF(O,11)))
    L2=(((C / REF(C,1)) > 1.041) ) * ( (BETWEEN(O / REF(O,11),1.05,0.92)))
    L3=(((CROSS(C,MA(C,5)) ) * ( CROSS(C,MA(C,10))) ) * ( (MA(C,10) > MA(C,20))) ) * ( (MA(C,5) > MA(C,20)))
    XG10=((L1 ) * ( L2) ) * ( L3)
    M1=((((REF(C,12) / REF(C,13)) > 1.095) ) * ( (REF(C,12) > REF(O,12))) ) * ( ((REF(C,13) / REF(C,14)) < 1.09))
    M2=(((C / REF(C,1)) > 1.041) ) * ( (BETWEEN(O / REF(O,12),1.05,0.92)))
    M3=(((CROSS(C,MA(C,5)) ) * ( CROSS(C,MA(C,10))) ) * ( (MA(C,10) > MA(C,20))) ) * ( (MA(C,5) > MA(C,20)))
    XG11=((M1 ) * ( M2) ) * ( M3)
    N1=(((REF(C,13) / REF(C,14)) > 1.095) ) * ( (REF(C,13) > REF(O,13)))
    N2=(((H / REF(C,1)) > 1.04) ) * ( (L < REF(C,13)))
    N3=((CROSS(C,MA(C,5)) ) * ( (MA(C,5) > MA(C,20))) ) * ( (C > MA(C,20)))
    XG12=((N1 ) * ( N2) ) * ( N3)
    ZHXG1=(((((((((((XG2) ) + ( (XG3)) ) + ( (XG4)) ) + ( (XG5)) ) + ( (XG6)) ) + ( (XG7)) ) + ( (XG8)) ) + ( (XG9)) ) + ( (XG10)) ) + ( (XG11)) ) + ( (XG12
))
    PH1=(((REF(C,9) / REF(C,10)) > 1.095) ) * ( (REF(C,9) > REF(O,9)))
    PH2=(((H / REF(C,1)) > 1.041) ) * ( (L < REF(C,9)))
    PH3=(((CROSS(C,MA(C,5)) ) * ( CROSS(C,MA(C,10))) ) * ( (MA(C,10) > MA(C,20))) ) * ( (MA(C,5) > MA(C,20)))
    PXG8=((PH1 ) * ( PH2) ) * ( PH3)
    PJ1=(((REF(C,10) / REF(C,11)) > 1.095) ) * ( (REF(C,10) > REF(O,10)))
    PJ2=(((H / REF(C,1)) > 1.041) ) * ( (L < REF(C,10)))
    PJ3=(((CROSS(C,MA(C,5)) ) * ( CROSS(C,MA(C,10))) ) * ( (MA(C,10) > MA(C,20))) ) * ( (MA(C,5) > MA(C,20)))
    PXG9=((PJ1 ) * ( PJ2) ) * ( PJ3)
    PL1=(((REF(C,11) / REF(C,12)) > 1.095) ) * ( (REF(C,11) > REF(O,11)))
    PL2=(((H / REF(C,1)) > 1.041) ) * ( (L < REF(C,11)))
    PL3=(((CROSS(C,MA(C,5)) ) * ( CROSS(C,MA(C,10))) ) * ( (MA(C,10) > MA(C,20))) ) * ( (MA(C,5) > MA(C,20)))
    PXG10=((PL1 ) * ( PL2) ) * ( PL3)
    PM1=((((REF(C,12) / REF(C,13)) > 1.095) ) * ( (REF(C,12) > REF(O,12))) ) * ( ((REF(C,13) / REF(C,14)) < 1.09))
    PM2=(((H / REF(C,1)) > 1.041) ) * ( (L < REF(C,12)))
    PM3=(((CROSS(C,MA(C,5)) ) * ( CROSS(C,MA(C,10))) ) * ( (MA(C,10) > MA(C,20))) ) * ( (MA(C,5) > MA(C,20)))
    PXG11=((PM1 ) * ( PM2) ) * ( PM3)
    VXG=((L < 压力位) ) * ( (C > 压力位))
    上轨道=(MA(C,25) + ((MA(C,25) * 20) / 100))
    CQSX=(CROSS(C,上轨道))
    ZHXG2=((((((PXG8) ) + ( (PXG9)) ) + ( (PXG10)) ) + ( (PXG11)) ) * ( VXG) ) * ( CQSX)
    PDM1=((((C / REF(C,1)) > 1.07) ) * ( ((C / O) > 1.05)) ) * ( ((H / C) < (C / O)))
    PDM2=(((BETWEEN(O / REF(H,1),1.01,1.08)) ) * ( ((C / REF(C,1)) > 1.041)) ) * ( ((REF(C,1) / REF(C,2)) < 1.04))
    PDM3=((((MA(C,5) > MA(C,10)) ) * ( (MA(C,10) > MA(C,20))) ) * ( (MA(C,10) > MA(C,30))) ) * ( (MA(C,30) > MA(C,60)))
    PDM4=(((REF(C,1) / REF(C,2)) < 1.09) ) * ( ((REF(C,2) / REF(C,3)) < 1.09))
    PDXG=(((count(REF(PDM1,1),20) ) * ( PDM2) ) * ( PDM3) ) * ( PDM4)
    YZB1=(((REF(C,3) / REF(C,4)) > 1.09) ) * ( (REF(C,3) == REF(O,3)))
    YZB2=(((H / REF(C,1)) >= 1.041) ) * ( (O < REF(C,3)))
    YZXG2=(YZB1 ) * ( YZB2)
    YZC1=(((REF(C,4) / REF(C,5)) > 1.09) ) * ( (REF(C,4) == REF(O,4)))
    YZC2=(((H / REF(C,1)) >= 1.041) ) * ( (O < REF(C,4)))
    YZXG3=(YZC1 ) * ( YZC2)
    YZZH=((YZXG2) ) + ( (YZXG3
))
    KM1=(((((((((C / REF(C,1)) > 1.095) ) * ( (C == H)) ) * ( (O < MA(C,10))) ) * ( (C > MA(C,10))) ) * ( (O < MA(C,20))) ) * ( (C > MA (C,20))) ) * ( (O < MA(C,30))) ) * ( (C > MA(C,30)))
    DM1=(((((((((H / REF(C,1)) > 1.041) ) * ( (L < MA(C,5))) ) * ( (C > MA(C,5))) ) * ( (L < MA(C,10))) ) * ( (C > MA(C,10))) ) * ( (L <  MA(C,20))) ) * ( (C > MA(C,20))) ) * ( ((((L < MA(C,60)) ) * ( (C > MA(C,60)))) ) + ( (((L < MA(C,120)) ) * ( (C > MA(C,120))))))
    KDXG=(count(REF(KM1,3),12) ) * ( DM1)
    GKB1=(((REF(C,3) / REF(C,4)) > 1.09) ) * ( (REF(C,3) > REF(O,3)))
    GKB2=((((((((H / REF(C,1)) >= 1.041) ) * ( ((H / REF(C,1)) >= 1.031)) ) * ( (BETWEEN(O / REF(O,3),1.06,0.92))) ) * ( (REF(V,1) <  REF(V,2))) ) * ( ((REF(H,2) / np.maximum(REF(O,2),REF(C,2))) < 1.07)) ) * ( ((MA(C,20) / MA(C,30)) < 1.05)) ) * ( (REF(L,2) < REF(C,3)))
    GKXG1=(GKB1 ) * ( GKB2)
    GKC1=(((REF(C,4) / REF(C,5)) > 1.09) ) * ( (REF(C,4) > REF(O,4)))
    GKC2=((((H / REF(C,1)) >= 1.041) ) * ( ((C / REF(C,1)) >= 1.031)) ) * ( (BETWEEN(O / REF(O,4),1.06,0.92)))
    GKC3=(((((((REF(V,1) < REF(V,2)) ) * ( (REF(V,2) < REF(V,3))) ) * ( ((REF(H,3) / np.maximum(REF(O,3),REF(C,3))) < 1.07)) ) * ( (H > MA (C,5))) ) * ( (C > MA(C,10))) ) * ( (C > MA(C,30))) ) * ( (REF(L,3) < REF(C,4)))
    GKXG2=((GKC1 ) * ( GKC2) ) * ( GKC3)
    GKXGXG=((GKXG1) ) + ( (GKXG2
))
    a=((((ZHXG1) ) + ( (ZHXG2)) ) + ( (YZZH)) ) + ( KDXG) + ( GKXGXG)
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
