...
#开始
    ...
    FS1=np.where(CG<FL1,(CG-(FL1-CG)),FL1)
    ...
    FS2=np.where(CG<FL2,(CG-(FL2-CG)),FL2)
    ...
    FS3=np.where(CG<FL3,(CG-(FL3-CG)),FL3)

    

    a=(REF(FL3,1)>REF(FS3,1)) * (FL3==FS3)
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
