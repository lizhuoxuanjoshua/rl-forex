...
#开始
    ...
    R1=(3*sma((C-llv(L,5))/(hhv(H,5)-llv(L,5))*100,5,1)-2*sma(sma((C-llv(L,5))/(hhv(H,5)-llv(L,5))*100,5,1),3,1))
    R2=(3*sma((C-llv(L,13))/(hhv(H,13)-llv(L,13))*100,5,1)-2*sma(sma((C-llv(L,13))/(hhv(H,13)-llv(L,13))*100,5,1),3,1))
    R3=(3*sma((C-llv(L,21))/(hhv(H,21)-llv(L,21))*100,5,1)-2*sma(sma((C-llv(L,21))/(hhv(H,21)-llv(L,21))*100,5,1),3,1))
    R4=(3*sma((C-llv(L,43))/(hhv(H,43)-llv(L,43))*100,5,1)-2*sma(sma((C-llv(L,43))/(hhv(H,43)-llv(L,43))*100,5,1),3,1))
    R5=(3*sma((C-llv(L,55))/(hhv(H,43)-llv(L,55))*100,5,1)-2*sma(sma((C-llv(L,55))/(hhv(H,55)-llv(L,55))*100,5,1),3,1))
    短趋势=((R1+R2+R3+R5+R4)/5)
    短趋势3=(EMA(短趋势,3))
    超短趋势=(短趋势-REF(短趋势,1))
    超短趋势3=(EMA(超短趋势,3))
    a=(CROSS(短趋势,短趋势3) ) * ( CROSS(超短趋势,超短趋势3))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
