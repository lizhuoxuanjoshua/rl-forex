...
#开始
    ...
    B2=(C/REF(C,1)>=1.041 ) * ( ((O/REF(O,3)<1.03) ) + ( (REF(O,1)/REF(O,3)<1.05)) ) * ( O<REF(C,3))
    XG2=(B1 ) * ( B2)
    C1=(REF(C,4)/REF(C,5)>1.09 ) * ( REF(C,4)>REF(O,4))
    C2=(C/REF(C,1)>=1.041 ) * ( ((O/REF(O,4)<1.03) ) + ( (REF(O,1)/REF(O,4)<1.05)) ) * ( O<REF(C,4))
    C3=(REF(C,4)>L)
    XG3=(C1 ) * ( C2 ) * ( C3)
    D1=(REF(C,5)/REF(C,6)>1.09 ) * ( REF(C,5)>REF(O,5))
    D2=(C/REF(C,1)>1.041  ) * ( BETWEEN(O/REF(O,5),1.05,0.85))
    XG4=(D1 ) * ( D2)
    E1=(REF(C,6)/REF(C,7)>1.09 ) * ( REF(C,6)>REF(O,6))
    E2=(C/REF(C,1)>1.041 ) * ( BETWEEN(O/REF(O,6),1.05,0.85))
    XG5=(E1 ) * ( E2)
    F1=(REF(C,7)/REF(C,8)>1.095 ) * ( REF(C,7)>REF(O,7))
    F2=(C/REF(C,1)>1.041 ) * ( BETWEEN(O/REF(O,7),1.05,0.85))
    XG6=(F1 ) * ( F2)
    G1=(REF(C,8)/REF(C,9)>1.095 ) * ( REF(C,8)>REF(O,8))
    G2=(C/REF(C,1)>1.041 ) * ( BETWEEN(O/REF(O,8),1.05,0.85))
    XG7=(G1 ) * ( G2)
    ...
    XG11=(M1 ) * ( M2 ) * ( M3)
    a=((XG2 )) + ( XG3)  + ( XG4)  + ( XG5)  + ( XG6)  + ( XG7)  + ( XG8)  + ( XG9)  + ( XG10)  + ( XG11)
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
