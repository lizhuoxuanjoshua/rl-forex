...
#开始
    ...
    a=(llv(100*EMA(EMA(C-REF(C,1),6),6)/EMA(EMA(np.abs(C-REF(C,1)),6),6),2)==llv(100*EMA(EMA(C-REF(C,1),6),6)/EMA(EMA(np.abs(C-REF(C,1)),6),6),7) ) * ( count(100*EMA(EMA(C-REF(C,1),6),6)/EMA(EMA(np.abs(C-REF(C,1)),6),6)<0,2) ) * ( CROSS(100*EMA(EMA(C-REF(C,1),6),6)/EMA(EMA(np.abs(C-REF(C,1)),6),6),MA(100*EMA(EMA(C-REF(C,1),6),6)/EMA(EMA(np.abs(C-REF(C,1)),6),6),2)))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
