...
#开始
    ...
    现价线=4*sma((CLOSE-llv(LOW,5))/(hhv(HIGH,5)-llv(LOW,5))*100,5,1)-3*sma(sma((CLOSE-llv(LOW,5))/(hhv(HIGH,5)-llv(LOW,5))*100,5,1),3.2,1)
    

    确认线=4*sma((CLOSE-llv(LOW,10))/(hhv(HIGH,10)-llv(LOW,10))*100,5,1)-3*sma(sma((CLOSE-llv(LOW,10))/(hhv(HIGH,10)-llv(LOW,10))*100,5,1),3.2,1)
