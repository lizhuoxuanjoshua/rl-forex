...
#开始
    ...
    黄牛线5=(EMA(HH,120))
    黄牛线6=(EMA(HH,250))
    离合=((黄牛线-((H-黄牛线)*H-黄牛线)/黄牛线))
    离合1=((黄牛线1-((H-黄牛线1)*H-黄牛线1)/黄牛线1))
    离合2=((黄牛线2-((H-黄牛线2)*H-黄牛线2)/黄牛线2))
    离合3=((黄牛线3-((H-黄牛线3)*H-黄牛线3)/黄牛线3))
    离合4=((黄牛线4-((H-黄牛线4)*H-黄牛线4)/黄牛线4))
    离合5=((黄牛线5-((H-黄牛线5)*H-黄牛线5)/黄牛线5))
    离合6=((黄牛线6-((H-黄牛线6)*H-黄牛线6)/黄牛线6))
    最大临界线=(np.maximum(离合6,np.maximum(离合5,np.maximum(离合4,np.maximum(离合3,np.maximum(离合2,np.maximum(离合1,离合)))))))
    AA=(CROSS(C,最大临界线))
    a=(AA ) * ( ZT)
#结束
    买入 = a
