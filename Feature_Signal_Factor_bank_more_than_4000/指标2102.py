...
#开始
    ...
    MY04=(H-REF(H,1))
    MY04A=(REF(L,1)-L)
    MY05=(EMA((MY04>0 ) * ( MY04>MY04A),14)*100/MY03)
    MY06=(EMA((MY04A>0 ) * ( MY04A>MY04),14)*100/MY03)
    MY07=(EMA(EMA(np.abs(MY06-MY05)/(MY06+MY05)*100,6),6))
    a=(MY01>REF(MY01,1) ) * ( REF(MY01,1)<10 ) * ( MY02>REF(MY02,1) ) * ( REF(MY02,1)<0 ) * ( MY07>REF(MY07,1) ) * ( 轨道Ａ>REF(轨道Ａ,1))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
