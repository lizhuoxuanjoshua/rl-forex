...
#开始
    ...
    B008=(REF(CLOSE,1))
    B009=(((((sma(np.maximum((CLOSE - B008),0),19,1) / sma(np.abs((CLOSE - B008)),19,1)) * 100) - 50) * 1.25))
    B010=(((((sma(np.maximum((CLOSE - B008),0),34,1) / sma(np.abs((CLOSE - B008)),34,1)) * 100) - 50) * 1.25))
    B011=(((((sma(np.maximum((CLOSE - B008),0),72,1) / sma(np.abs((CLOSE - B008)),72,1)) * 100) - 50) * 1.25))
