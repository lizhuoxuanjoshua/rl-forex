...
#开始
    ...
    AAA=(np.minimum(np.minimum(np.minimum(np.minimum(np.minimum(PB1,PB2),PB3),PB4),PB5),PB6))
    BBB=(np.maximum(np.maximum(np.maximum(np.maximum(np.maximum(PB1,PB2),PB3),PB4),PB5),PB6))
    XG=(((O<AAA) ) + ( (REF(O<AAA,1))) ) * ( C>BBB)
