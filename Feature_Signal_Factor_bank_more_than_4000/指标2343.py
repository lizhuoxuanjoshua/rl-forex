...
#开始
    ...
    VAR4=(CROSS(EMA(CLOSE,2),EMA((SLOPE(CLOSE,21))*(20)+CLOSE,42)))
    VER5=((2)*((2)*(EMA(CLOSE,5)-EMA(CLOSE,10))+(2)*(EMA(CLOSE,5)-EMA(CLOSE,30))))
    VER6=(((CLOSE-REF(OPEN,29))/(REF(OPEN,29)))*(100))
    SEA=(CROSS(VER5,0))
    RAY=(CROSS(VAR1,MA(VAR2,6)))
