...
#开始
    ...
    VAR11=(FILTER((llv(VAR9,2)==llv(VAR9,7) ) * ( count(VAR9<0,2) ) * ( CROSS(VAR9,MA(VAR9,2)))==1,5))
    VAR12=(FILTER((hhv(VAR9,2)==hhv(VAR9,7) ) * ( count(VAR9>50,2) ) * ( CROSS(MA(VAR9,2),VAR9))==1,1))
    VAR13=(sma(EMA((C-REF(C,1))/REF(C,1),5)*100,3,1)*10)
    VAR14=(FILTER((((CROSS(VAR13,0)) ) + ( (CROSS(C,VAR10))) ) * ( VAR11)==1,3))
