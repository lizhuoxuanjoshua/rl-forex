...
#开始
    ...
    VARX1=((hhv(HIGH,50)-CLOSE)/(hhv(HIGH,50)-llv(LOW,50)))
    VARX2=(sma(VARX1,47,1)+10)
    VARX3=((CLOSE-llv(LOW,48))/(hhv(HIGH,48)-llv(LOW,48)))
    VARX4=(sma(VARX3,3,1))
    VARX5=(sma(VARX4,3,1)+10)
    DDDD=(VARX5-VARX2)
    a=(CROSS(DDDD,REF(DDDD,1)))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
