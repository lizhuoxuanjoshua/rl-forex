...
#开始
    ...
    VAR5=(VAR4*(1+VAR3))
    VAR6=(REF(VOL,1))
    VAR7=(sma(np.maximum(VOL-VAR6,0),6,1)/sma(np.abs(VOL-VAR6),6,1)*100)
    VAR8=(VAR5>REF(VAR5,1) ) * ( VAR2<REF(VAR2,1) ) * ( VAR7>REF(VAR7,1))
    VAR9=(VAR5<REF(VAR5,1) ) * ( VAR2>REF(VAR2,1) ) * ( VAR7>REF(VAR7,1))
    VAR10=(VAR5>REF(VAR5,1) ) * ( VAR2<REF(VAR2,1) ) * ( VAR7<REF(VAR7,1))
    VAR11=(VAR5<REF(VAR5,1) ) * ( VAR2>REF(VAR2,1) ) * ( VAR7<REF(VAR7,1))
    ...
    VAR20=(VAR12 ) * ( VAR15)
    XG=(LAST(VAR19,7,1) ) * ( VAR20)
    a=(CROSS(XG,VAR19) ) * ( VAR20<2.1 ) * ( C>O)
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
