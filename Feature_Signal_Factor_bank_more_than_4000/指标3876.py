...
#开始
    ...
    X_1=(CLOSE<=REF(CLOSE,4))
    X_2=(CLOSE>REF(CLOSE,4))
    X_3=(CLOSE>REF(CLOSE,4) ) * ( REF(X_1,1))
    X_4=(barslast(X_3))
    X_5=(X_4==1 ) * ( REF(X_4==0 ) * ( X_3) ) * ( X_2)
    X_6=(X_4==2 ) * ( X_2)
    X_7=(X_4==0)
    X_8=(X_5)
    X_9=(X_6)
    ...
    X_15=(MA(CLOSE,3*3))
    X_16=(MA(CLOSE,4*3))
    X_17=(MA((X_13+X_14+X_15+X_16)/4,5))
    X_18=(EMA(CLOSE,3))
    X_19=((EMA(X_12,3)+EMA(X_12,6)+EMA(X_12,12)+EMA(X_12,24))/4)
    X_20=(EMA(EMA(EMA(CLOSE,2),2),2))
    X_21=(MA(X_20,13)*0.999)
    X_22=(X_18>X_19 ) * ( X_18>X_21 ) * ( ((X_18<X_19) ) + ( (X_18<X_21)))
    X_23=(REF(X_22,1))
    X_24=((X_22) ) + ( (X_23
))
    X_25=(1*AMOUNT)
    X_26=(llv(X_25,30)==X_25)
    X_27=(llv(X_25,60)==X_25)
    X_28=(llv(X_25,100)==X_25)
    X_29=(llv(X_25,250)==X_25)
    X_30=((X_26) ) + ( (X_27) ) + ( (X_28) ) + ( (X_29
))
    X_31=((X_30) ) + ( (REF(X_30,1)) ) + ( (REF(X_30,2)) ) + ( (REF(X_30,3)
))
