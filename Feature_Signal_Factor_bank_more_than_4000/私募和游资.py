...
#开始
    ...
    np.maximum1=np.maximum(MA20,MA30)

    

    np.maximum2=np.maximum(np.maximum1,MA60)

    

    np.minimum11=np.minimum(MA20,MA30)

    

    np.minimum2=np.minimum(np.minimum11,MA60)

    

    K1=(np.maximum2/np.minimum2-1)*100

    

    VAR2=np.where(K1<=8,1,0)
    ...
    B2=sma(sma(sma(BBB1,2,1),2,1),2,1)
