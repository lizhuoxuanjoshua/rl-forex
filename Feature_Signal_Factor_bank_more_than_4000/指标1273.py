...
#开始
    ...
    MA24=(MA(CLOSE,120))
    MA25=(MA(CLOSE,250))
    ZX1=(np.maximum(MA1,np.maximum(MA2,np.maximum(MA3,np.maximum(MA4,np.maximum(MA5,np.maximum(MA6,np.maximum(MA7,np.maximum(MA8,np.maximum(MA9,np.maximum(MA10,np.maximum(MA11,np.maximum(MA12,np.maximum(MA13,np.maximum(MA14,np.maximum(MA15,np.maximum(MA16,np.maximum(MA17,np.maximum(MA18,np.maximum(MA19,np.maximum(MA20,np.maximum(MA21,np.maximum(MA22,np.maximum(MA23,MA24))))))))))))))))))))))))
    ZX2=(np.minimum(MA1,np.minimum(MA2,np.minimum(MA3,np.minimum(MA4,np.minimum(MA5,np.minimum(MA6,np.minimum(MA7,np.minimum(MA8,np.minimum(MA9,np.minimum(MA10,np.minimum(MA11,np.minimum(MA12,np.minimum(MA13,np.minimum(MA14,np.minimum(MA15,np.minimum(MA16,np.minimum(MA17,np.minimum(MA18,np.minimum(MA19,np.minimum(MA20,np.minimum(MA21,np.minimum(MA22,np.minimum(MA23,MA24))))))))))))))))))))))))
