...
#开始
    ...
    AA=(CROSS(((HIGH + LOW + CLOSE)/(3) - MA((HIGH + LOW + CLOSE)/(3),10))/((0.015)*(AVEDEV((HIGH + LOW + CLOSE)/(3),10))),(-200)) ) * ( (((HIGH + LOW + CLOSE)/(3) - MA((HIGH + LOW + CLOSE)/(3),5))/((0.015)*(AVEDEV((HIGH + LOW + CLOSE)/(3),5))) > (-100)))
    a=(FILTER(AA,5))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
