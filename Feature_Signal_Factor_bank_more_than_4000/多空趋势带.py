...
#开始
    ...
    VAR31=(3*CLOSE+LOW+OPEN+HIGH)/6

    VAR41=(20*VAR31+19*REF(VAR31,1)+18*REF(VAR31,2)+17*REF(VAR31,3)+16*REF(VAR31,4)+15*REF(VAR31,5)+14*REF(VAR31,6)+13*REF(VAR31,7)+12*REF(VAR31,8)+11*REF(VAR31,9)+10*REF(VAR31,10)+9*REF(VAR31,11)+8*REF(VAR31,12)+7*REF(VAR31,13)+6*REF(VAR31,14)+5*REF(VAR31,15)+4*REF(VAR31,16)+3*REF(VAR31,17)+2*REF(VAR31,18)+REF(VAR31,20))/210
