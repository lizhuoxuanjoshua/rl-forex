...
#开始
    ...
    AA=(np.where((EMA((C*2+H+L)/4,1)-EMA((C*2+H+L)/4,40)-EMA(EMA((C*2+H+L)/4,1)-EMA((C*2+H+L)/4,40),5))*100<-20,-20,np.where((EMA((C*2+H+L)/4,1)-EMA((C*2+H+L)/4,40)-EMA(EMA((C*2+H+L)/4,1)-EMA((C*2+H+L)/4,40),5))*100>100,100,(EMA((C*2+H+L)/4,1)-EMA((C*2+H+L)/4,40)-EMA(EMA((C*2+H+L)/4,1)-EMA((C*2+H+L)/4,40),5))*100)))
    AB=(np.where((3*(hhv(HIGH,5)-CLOSE)/(hhv(HIGH,5)-llv(LOW,5))*20-2*sma((hhv(HIGH,5)-CLOSE)/(hhv(HIGH,5)-llv(LOW,5))*20,3,1))*1>100,100,np.where((3*(hhv(HIGH,5)-CLOSE)/(hhv(HIGH,5)-llv(LOW,5))*20-2*sma((hhv(HIGH,5)-CLOSE)/(hhv(HIGH,5)-llv(LOW,5))*20,3,1))*1<-5,-5,(3*(hhv(HIGH,5)-CLOSE)/(hhv(HIGH,5)-llv(LOW,5))*20-2*sma((hhv(HIGH,5)-CLOSE)/(hhv(HIGH,5)-llv(LOW,5))*20,3,1))*1)))
    AC=(np.where((hhv(HIGH,13)-CLOSE)/(hhv(HIGH,13)-llv(LOW,13))*120>100,100,(hhv(HIGH,13)-CLOSE)/(hhv(HIGH,13)-llv(LOW,13))*120))
    a=(CROSS(AA,AB) ) * ( CROSS(80,AC))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
