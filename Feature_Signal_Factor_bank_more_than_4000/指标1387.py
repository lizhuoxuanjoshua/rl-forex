...
#开始
    ...
    EMA120=(EMA(C,120))
    EMA250=(EMA(C,250))
    F1=(EMA30-EMA60<130/1000 ) * ( EMA30-EMA90<230/1000 ) * ( EMA30-EMA120<330/1000)
    F2=(EMA60-EMA30<130/1000 ) * ( EMA60-EMA90<230/1000 ) * ( EMA60-EMA120<330/1000)
    F3=(EMA90-EMA30<130/1000 ) * ( EMA90-EMA60<230/1000 ) * ( EMA90-EMA120<330/1000)
    F4=(EMA120-EMA30<130/1000 ) * ( EMA120-EMA60<230/1000 ) * ( EMA120-EMA90<330/1000)
    F5=(EMA30-EMA60<100/1000 ) * ( EMA30-EMA90<200/1000)
    FF1=(F1 ) * ( F2 ) * ( F3 ) * ( F4 ) * ( CROSS(EMA30,EMA60))
    FF2=(F1 ) * ( F2 ) * ( F3 ) * ( F4 ) * ( CROSS(EMA(C,13),EMA30))
    FF3=(F5 ) * ( C>EMA250 ) * ( CROSS(EMA30,EMA60))
    G1=(EMA60-EMA90<220/1000 ) * ( EMA60-EMA120<320/1000 ) * ( EMA60-EMA250<420/1000)
    G2=(EMA90-EMA30<220/1000 ) * ( EMA90-EMA60<320/1000 ) * ( EMA90-EMA250<420/1000)
    G3=(EMA120-EMA60<220/1000 ) * ( EMA120-EMA90<320/1000 ) * ( EMA120-EMA250<420/1000)
    G4=(EMA250-EMA60<220/1000 ) * ( EMA250-EMA90<320/1000 ) * ( EMA250-EMA120<420/1000)
    GG1=(G1 ) * ( G2 ) * ( G3 ) * ( G4 ) * ( CROSS(EMA13,EMA30))
    GG2=(G1 ) * ( G2 ) * ( G3 ) * ( G4 ) * ( CROSS(EMA30,EMA60))
    a=((FF1) ) + ( (FF2) ) + ( (FF3) ) + ( (GG1) ) + ( (GG2))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
