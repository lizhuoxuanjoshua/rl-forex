...
#开始
    ...
    EMA30=(EMA(C,30))
    EMA60=(EMA(C,60))
    M1=(1000*EMA10/EMA60<=1015 ) * ( 1000*EMA10/EMA60>=975)
    M2=(1000*EMA20/EMA60<=1020 ) * ( 1000*EMA20/EMA60>=980)
    M3=(1000*EMA30/EMA60<=1015 ) * ( 1000*EMA30/EMA60>=985)
    M4=(M1 ) * ( M2 ) * ( M3 ) * ( CROSS(V0,EMA10))
    M5=(M1 ) * ( M2 ) * ( M3 ) * ( CROSS(V0,EMA30))
    T1=(1000*EMA10/EMA30<=1010 ) * ( 1000*EMA10/EMA30>=990)
    T2=(1000*EMA20/EMA30<=1010 ) * ( 1000*EMA20/EMA30>=990)
    T3=(T1 ) * ( T2 ) * ( CROSS(V0,EMA10))
    T4=(T1 ) * ( T2 ) * ( CROSS(V0,EMA30))
    a=((M4) ) + ( (M5) ) + ( (T3) ) + ( (T4))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
