...
#开始
    ...
    HMSQ1=(3*sma((CLOSE-llv(LOW,9))/(hhv(HIGH,9)-llv(LOW,9))*100,3,1)-2*sma(sma((CLOSE-llv(LOW,9))/(hhv(HIGH,9)-llv(LOW,9))*100,3,1),3,1))
    HMSQ2=(HMSQ1>REF(HMSQ1,1) ) * ( REF(HMSQ1,1)<REF(HMSQ1,2)  ) * ( 30>REF(HMSQ1,1))
    HMSQ3=((hhv(HIGH,9)-CLOSE)/(hhv(HIGH,9)-llv(LOW,9))*100-70)
    HMSQ4=((CLOSE-llv(LOW,9))/(hhv(HIGH,9)-llv(LOW,9))*100)
    HMSQ5=(np.where(((sma(sma(HMSQ4,3,1),3,1)+100)-(sma(HMSQ3,9,1)+100))>45,((sma(sma(HMSQ4,3,1),3,1)+100)-(sma(HMSQ3,9,1)+100))-45,0))
    HMSQ6=(HMSQ5>REF(HMSQ5,1) ) * ( REF(HMSQ5,1)<REF(HMSQ5,2))
