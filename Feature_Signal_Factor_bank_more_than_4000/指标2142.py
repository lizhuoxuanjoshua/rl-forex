...
#开始
    ...
    A9=(barslast(CROSS(GJTJ4,GJTJ1))>3 ) * ( barslast(CROSS(GJTJ1,GJTJ4))<3)
    B9=(barslast(CROSS(GJTJ4,GJTJ2)))
    D9=(GJTJ3<GJTJ4 ) * ( GJTJ2<GJTJ4)
    E9=(barslast(CROSS(GJTJ4,GJTJ3))>3 ) * ( barslast(CROSS(GJTJ1,GJTJ4))<3)
    F9=(GJTJ2<GJTJ3 ) * ( GJTJ2<GJTJ4 ) * ( GJTJ2<GJTJ1 ) * ( GJTJ1==100)
    B91=(A9>0 ) * ( REF(A9,1)==0 ) * ( REF(A9,2)>0)
    a=(A9 ) * ( B9 ) * ( D9 ) * ( E9 ) * ( F9)
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
