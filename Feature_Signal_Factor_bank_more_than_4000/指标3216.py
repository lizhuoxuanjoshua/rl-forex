...
#开始
    ...
    VAR18=(((sma(np.maximum(VAR12,0),6,1))/(sma(np.abs(VAR12),6,1)))*(100))
    ...
    VAR20=((VAR18<=25) ) * ( (VAR19<(-95)) ) * ( (VAR1F>20) ) * ( (VAR1B<(-30)) )  * ( (VAR11-CLOSE>=(-0.25)) ) * ( (VAR15<22) ) * ( (VAR16<28) ) * ( (VAR17>50))
    a=(CROSS(VAR20,0.5) ) * ( (count((VAR20==1),10)==1))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
