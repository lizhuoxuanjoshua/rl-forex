...
#开始
    ...
    MA2=(count(AMOUNT,2)/count(V,2))
    MA3=(count(AMOUNT,3)/count(V,3))
    MA4=(count(AMOUNT,4)/count(V,4))
    MA5=(count(AMOUNT,5)/count(V,5))
    MA6=(count(AMOUNT,6)/count(V,6))
    MA7=(count(AMOUNT,7)/count(V,7))
    MA8=(count(AMOUNT,8)/count(V,8))
    MA9=(count(AMOUNT,9)/count(V,9))
    MA10=(count(AMOUNT,10)/count(V,10))
    MA11=(count(AMOUNT,11)/count(V,11))
    MA12=(count(AMOUNT,12)/count(V,12))
    MA13=(count(AMOUNT,13)/count(V,13))
    MA14=(count(AMOUNT,14)/count(V,14))
    MA15=(count(AMOUNT,15)/count(V,15))
    MA16=(count(AMOUNT,16)/count(V,16))
    MA17=(count(AMOUNT,17)/count(V,17))
    MA18=(count(AMOUNT,18)/count(V,18))
    MA19=(count(AMOUNT,19)/count(V,19))
    A=(np.maximum(MA2,np.maximum(MA3,np.maximum(MA4,np.maximum(MA5,np.maximum(MA6,np.maximum(MA7,np.maximum(MA8,np.maximum(MA9,np.maximum(MA10,np.maximum(MA11,np.maximum(MA12,np.maximum(MA13,np.maximum(MA14,np.maximum(MA15,np.maximum(MA16,np.maximum(MA17,np.maximum(MA18,MA19))))))))))))))))))
    B=(np.minimum(MA2,np.minimum(MA3,np.minimum(MA4,np.minimum(MA5,np.minimum(MA6,np.minimum(MA7,np.minimum(MA8,np.minimum(MA9,np.minimum(MA10,np.minimum(MA11,np.minimum(MA12,np.minimum(MA13,np.minimum(MA14,np.minimum(MA15,np.minimum(MA16,np.minimum(MA17,np.minimum(MA18,MA19))))))))))))))))))
    a=(((A-B)/B)*100<10 ) * ( CROSS(C,A))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
