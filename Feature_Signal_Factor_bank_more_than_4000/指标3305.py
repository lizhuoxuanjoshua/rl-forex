...
#开始
    ...
    LC=(REF(CLOSE,1))
    RSI1=(sma(np.maximum(CLOSE-LC,0),2,1)/sma(np.abs(CLOSE-LC),2,1)*100)
    RSI2=(sma(np.maximum(CLOSE-LC,0),3,1)/sma(np.abs(CLOSE-LC),3,1)*100)
    RSI3=(sma(np.maximum(CLOSE-LC,0),4,1)/sma(np.abs(CLOSE-LC),4,1)*100)
    RSI4=(sma(np.maximum(CLOSE-LC,0),5,1)/sma(np.abs(CLOSE-LC),5,1)*100)
    RSI5=(sma(np.maximum(CLOSE-LC,0),6,1)/sma(np.abs(CLOSE-LC),6,1)*100)
    RSI6=(sma(np.maximum(CLOSE-LC,0),7,1)/sma(np.abs(CLOSE-LC),7,1)*100)
    RSI7=(sma(np.maximum(CLOSE-LC,0),8,1)/sma(np.abs(CLOSE-LC),8,1)*100)
    RSI8=(sma(np.maximum(CLOSE-LC,0),9,1)/sma(np.abs(CLOSE-LC),9,1)*100)
    RSI9=(sma(np.maximum(CLOSE-LC,0),10,1)/sma(np.abs(CLOSE-LC),10,1)*100)
    RSI10=(sma(np.maximum(CLOSE-LC,0),11,1)/sma(np.abs(CLOSE-LC),11,1)*100)
    RSI11=(sma(np.maximum(CLOSE-LC,0),12,1)/sma(np.abs(CLOSE-LC),12,1)*100)
    RSI12=(sma(np.maximum(CLOSE-LC,0),13,1)/sma(np.abs(CLOSE-LC),13,1)*100)
    RSI13=(sma(np.maximum(CLOSE-LC,0),14,1)/sma(np.abs(CLOSE-LC),14,1)*100)
    RSI14=(sma(np.maximum(CLOSE-LC,0),15,1)/sma(np.abs(CLOSE-LC),15,1)*100)
    RSI15=(sma(np.maximum(CLOSE-LC,0),16,1)/sma(np.abs(CLOSE-LC),16,1)*100)
    RSI16=(sma(np.maximum(CLOSE-LC,0),17,1)/sma(np.abs(CLOSE-LC),17,1)*100)
    RSI17=(sma(np.maximum(CLOSE-LC,0),18,1)/sma(np.abs(CLOSE-LC),18,1)*100)
    RSI18=(sma(np.maximum(CLOSE-LC,0),19,1)/sma(np.abs(CLOSE-LC),19,1)*100)
    RSI19=(sma(np.maximum(CLOSE-LC,0),20,1)/sma(np.abs(CLOSE-LC),20,1)*100)
    RSI21=(sma(np.maximum(CLOSE-LC,0),21,1)/sma(np.abs(CLOSE-LC),21,1)*100)
    RSI30=(sma(np.maximum(CLOSE-LC,0),30,1)/sma(np.abs(CLOSE-LC),30,1)*100)
    RSI40=(sma(np.maximum(CLOSE-LC,0),40,1)/sma(np.abs(CLOSE-LC),40,1)*100)
    RSI50=(sma(np.maximum(CLOSE-LC,0),50,1)/sma(np.abs(CLOSE-LC),50,1)*100)
    RSI60=(sma(np.maximum(CLOSE-LC,0),60,1)/sma(np.abs(CLOSE-LC),60,1)*100)
    RSI70=(sma(np.maximum(CLOSE-LC,0),70,1)/sma(np.abs(CLOSE-LC),70,1)*100)
    RSI80=(sma(np.maximum(CLOSE-LC,0),80,1)/sma(np.abs(CLOSE-LC),80,1)*100)
    RSI90=(sma(np.maximum(CLOSE-LC,0),90,1)/sma(np.abs(CLOSE-LC),90,1)*100)
    RSI100=(sma(np.maximum(CLOSE-LC,0),100,1)/sma(np.abs(CLOSE-LC),100,1)*100)
    RSI110=(sma(np.maximum(CLOSE-LC,0),110,1)/sma(np.abs(CLOSE-LC),110,1)*100)
    RSI120=(sma(np.maximum(CLOSE-LC,0),120,1)/sma(np.abs(CLOSE-LC),120,1)*100)
    ARSI=((RSI1+RSI2+RSI3+RSI4+RSI5)/5)
    BRSI=((RSI6+ RSI7+ RSI8+ RSI9+ RSI10+ RSI11+ RSI12+ RSI13+ RSI14+ RSI15+ RSI16+ RSI17+ RSI18+ RSI19+ RSI21)/15)
    a=(CROSS(ARSI,BRSI))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
