...
#开始
    ...
    X_5=(MA(CLOSE,X_2))
    X_6=(MA(CLOSE,X_3))
    X_7=(barslast(CROSS(X_4,X_5)))
    X_8=(barslast(CROSS(X_4,X_6)))
    X_9=(barslast(CROSS(X_5,X_6)))
    X_10=(X_7>=X_8 ) * ( X_8>X_9)
    X_11=(count(CROSS(X_4,X_5),X_7+1)==1 ) * ( count(CROSS(X_4,X_6),X_7+1)==1 ) * ( CROSS(X_5,X_6) ) * ( X_4>X_5 ) * ( X_5>X_6)
    X_12=(X_10 ) * ( X_11)
    a=(barslast(X_12)<=30)
#结束
    买入 = a
