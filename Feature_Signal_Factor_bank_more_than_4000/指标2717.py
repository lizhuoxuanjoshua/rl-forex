...
#开始
    ...
    BAIJIN1=(barslast(CROSS(30,GJTJ1))<2 ) * ( barslast(CROSS(GJTJ1,50))<2)
    BAIJIN2=(barslast(CROSS(GJTJ4,GJTJ1))<2 ) * ( GJTJ1>GJTJ4)
    BAIJIN3=(GJTJ1>60 ) * ( GJTJ4>70)
    HUANGJIN1=(barslast(CROSS(50,GJTJ1))<3 ) * ( barslast(CROSS(GJTJ1,50))<3)
    HUANGJIN2=(barslast(CROSS(GJTJ4,GJTJ1))<2 ) * ( GJTJ1>GJTJ4)
    ZHENCANG1=(barslast(CROSS(GJTJ4,GJTJ1))>3 ) * ( barslast(CROSS(GJTJ1,GJTJ4))<3)
    ZHENCANG2=(barslast(CROSS(GJTJ4,GJTJ2)))
    ZHENCANG3=(GJTJ3<GJTJ4 ) * ( GJTJ2<GJTJ4)
    ZHENCANG4=(barslast(CROSS(GJTJ4,GJTJ3))>3 ) * ( barslast(CROSS(GJTJ1,GJTJ4))<3)
    ZHENCANG5=(GJTJ2<GJTJ3 ) * ( GJTJ2<GJTJ4 ) * ( GJTJ2<GJTJ1 ) * ( GJTJ1==100)
    ZCB1=(ZHENCANG1>0 ) * ( REF(ZHENCANG1,1)==0 ) * ( REF(ZHENCANG1,2)>0)
    AA=(barslast(CROSS(97,GJTJ1))<=1 ) * ( barslast(CROSS(GJTJ1,85))<=1)
    BB=(barslast(CROSS(97,GJTJ2))<=1 ) * ( barslast(CROSS(GJTJ2,85))<=1)
    AA1=(AA ) * ( BB)
    AAA=(barslast(CROSS(97,GJTJ1))<=2 ) * ( barslast(CROSS(GJTJ1,85))<=1)
    BAA=(barslast(CROSS(97,GJTJ2))<=2 ) * ( barslast(CROSS(GJTJ2,85))<=1)
    AA2=(AA ) * ( BB)
    AAAA=(barslast(CROSS(97,GJTJ1))<=3 ) * ( barslast(CROSS(GJTJ1,85))<=1)
    BAAA=(barslast(CROSS(97,GJTJ2))<=3 ) * ( barslast(CROSS(GJTJ2,85))<=1)
    AA3=(AAAA ) * ( BAAA)
    BB1=(REF(AA1,1))
    BB2=(REF(AA2,1))
    BB3=(REF(AA3,1))
    DD1=(GJTJ1==100 ) * ( GJTJ2==100 ) * ( AA1)
    DD2=(GJTJ1==100 ) * ( GJTJ2==100 ) * ( AA2)
    DD3=(GJTJ1==100 ) * ( GJTJ2==100 ) * ( AA3)
    AW=(barslast(CROSS(95,GJTJ1))<=2)
    BW=(barslast(CROSS(95,GJTJ2))<=2)
    EW=( GJTJ4<GJTJ1 ) * ( GJTJ1<GJTJ2 ) * ( GJTJ1<GJTJ3)
    FW=(GJTJ2>50 ) * ( GJTJ3>50)
    GW=(GJTJ1==100 ) * ( GJTJ2==100)
    TXW=(count(GW,2)==1)
    a=(AW ) * ( BW ) * ( EW ) * ( FW ) * ( TXW)
#结束
    买入 = a
