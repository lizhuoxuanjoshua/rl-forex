...
#开始
    ...
    MA30=(MA(C,30))
    MA60=(MA(C,60))
    TJ1=(C>MA5 ) * ( C>MA10 ) * ( C>MA30 ) * ( C>MA60 ) * ( MA30>MA5 ) * ( MA30>MA10 ) * ( MA30>MA60 ) * ( MA10>MA5 ) * ( MA10>MA60 ) * ( MA5>REF(MA5,1))
    TJ2=(C>MA5 ) * ( C>MA10 ) * ( C>MA30 ) * ( C<MA60 ) * ( MA60>MA5 ) * ( MA60>MA10 ) * ( MA60>MA30 ) * ( MA5>MA10 ) * ( MA5>MA30 ) * ( MA5>REF(MA5,1))
    TJ3=(C>MA30 ) * ( C>MA60 ) * ( C<MA5 ) * ( C<MA10 ) * ( MA10>MA5 ) * ( MA10>MA30 ) * ( MA10>MA60 ) * ( MA30>MA60)
    a=((TJ1) ) + ( (TJ2) ) + ( (TJ3
))
#结束
    买入 = a
