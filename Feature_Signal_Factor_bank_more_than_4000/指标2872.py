...
#开始
    ...
    MA30=(MA(CLOSE,30))
    MA60=(MA(CLOSE,60))
    OK1=((CLOSE > MA5) ) * ( (CLOSE > MA10) ) * ( (CLOSE > MA20) ) * ( (CLOSE > MA30) ) * ( ((LOW)*(0.9) < MA5) ) * ( ((LOW)*(0.9) < MA10) ) * ( ((LOW)*(0.9) < MA20) ) * ( ((LOW)*(0.9) < MA30))
    OK2=((CLOSE > MA5) ) * ( (CLOSE > MA10) ) * ( (CLOSE > MA20) ) * ( (CLOSE > MA30) ) * ( (CLOSE > MA30) ) * ( ((LOW)*(0.9) < MA5) ) * ( ((LOW)*(0.9) < MA10) ) * ( ((LOW)*(0.9) < MA20) ) * ( ((LOW)*(0.9) < MA30) ) * ( ((LOW)*(0.9) < MA60))
    银疙瘩5=(AA1 ) * ( (barslast(AA2) < 6) ) * ( OK2)
    银疙瘩6=(AA2 ) * ( (barslast(AA1) < 6) ) * ( OK2)
    银疙瘩7=(AA3 ) * ( (barslast(AA1) < 6) ) * ( OK2)
    银疙瘩8=(AA4 ) * ( (barslast(AA1) < 6) ) * ( OK2)
    a=((银疙瘩5) ) + ( (银疙瘩6) ) + ( (银疙瘩7) ) + ( (银疙瘩8))
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
    测试信号 =买入
