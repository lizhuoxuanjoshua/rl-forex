...
#开始
    ...
    AA=(3*sma((C-llv(L,13))/(hhv(H,13)-llv(L,13))*100,5,1)-2*sma(sma((C-llv(L,13))/(hhv(H,13)-llv(L,13))*100,5,1),3,1))
    吸筹1=(AA<=10)
    N=(5)
    ...
    VAR4=(EMA(np.where(CLOSE*1.3,VAR3*10,VAR3/10),3))
    VAR5=(llv(LOW,13))
    VAR6=(hhv(VAR4,13))
    VAR7=(np.where(MA(CLOSE,34),1,0))
    VAR8=(EMA(np.where(LOW<=VAR5,(VAR4+VAR6*2)/2,0),3)/618*VAR7)
    VAR9=(np.where(VAR8>100,100,VAR8))
