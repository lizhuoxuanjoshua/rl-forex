...
#开始
    ...
    AC=(((3*sma((CLOSE-llv(LOW,100))/(hhv(HIGH,100)-llv(LOW,100))*100,3,1)-2*sma(sma((CLOSE-llv(LOW,100))/(hhv(HIGH,100)-llv(LOW,100))*100,3,1),3,1)-40)*1.032+50))
    VAR2=((2*CLOSE+HIGH+LOW+OPEN)/5)
    VAR3=(llv(LOW,34))
    VAR4=(hhv(HIGH,34))
    AB=(EMA((VAR2-VAR3)/(VAR4-VAR3)*100,5))

    VAR5=(CROSS(AC,AB)) * ( AB<25)
    a=(VAR5 )
#结束
    买入 = a
    #确定买入和测试信号------------------------------------------------------
